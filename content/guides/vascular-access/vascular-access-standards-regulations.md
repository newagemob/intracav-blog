...
1. Insert catheters only when necessary and remove them as soon as they are no longer needed
2. Implement evidence-based guidelines for insertion and maintenance of central venous catheters
3. Monitor compliance with the above practices
...
Standards translate to practice through the institutional **policy and procedure** layer. Clinical policies (like those in the Intracav Policies library) cite these primary standards as their authority base, adapting them to local practice context.
...
- [Evidence-Based Practice Research](/policies/evidence-based-practice-research/)
...
5. Buetti N, et al. (2022). SHEA/IDSA CLABSI prevention 2022 update. *Infect Control Hosp Epidemiol*, 43(5):553–569.
