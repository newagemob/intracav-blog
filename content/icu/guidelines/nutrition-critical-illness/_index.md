+++
title = "Nutrition in Critical Illness: A Comprehensive Clinical Guideline"
description = "Evidence-based guideline for nutritional assessment, enteral and parenteral nutrition, micronutrient supplementation, and special population management in the critically ill patient."
...
audience = "clinician"
departments = ["icu"]
category = ["guidelines", "icu", "critical-care", "nutrition", "enteral-nutrition", "parenteral-nutrition"]
tags = ["ICU-nutrition", "enteral-nutrition", "parenteral-nutrition", "NUTRIC-score", "refeeding-syndrome", "indirect-calorimetry"]
keywords = ["critical care nutrition guidelines", "ICU enteral nutrition", "parenteral nutrition ICU", "refeeding syndrome prevention"]
aliases = ["/guidelines/icu/nutrition-critical-illness/"]
+++
...
[^6]: Heyland DK, Dhaliwal R, Wang M, Day AG. "The prevalence of iatrogenic underfeeding in the nutritionally 'at-risk' critically ill patient: Results of an international, multicenter, prospective study." *Clin Nutr*. 2015;34(4):659-666. DOI: [10.1016/j.clnu.2014.07.008](https://doi.org/10.1016/j.clnu.2014.07.008)
