+++
title = "IP Guideline Development Handbook — Part 3: Development Checklists, Author Roles & Inclusive Language"
description = "Development checklists (32-month, 22-month, and 6-month timelines), review and comment period procedures, writing panel author responsibilities, inclusive language guide, and acronyms for infection prevention guideline development."
date = 2024-09-01T00:00:00-05:00
lastmod = 2024-11-26T00:00:00-05:00
draft = false
weight = 3
source_org = "ip_handbook"
guideline_set = "ip_guideline_dev_handbook_2024"
category = ["guidelines", "infection-prevention", "methodology"]
audience = "clinician"
content_type = "guidelines"
departments = ["infection-prevention"]
aliases = ["/guidelines/ip/guideline-development-handbook/part-3-appendices-checklists-review-language/"]
+++
...
| 8. If applicable, document submitted for CDC clearance at the same time as final approval by authoring organizations | Compendium format, guidelines | CDC [^3] |
...
- For all paid and unpaid persons who serve in healthcare settings and whose primary intent is to protect or improve health, use **healthcare personnel (HCP)** [^3]. When needed, collectively HCP also may be referred to as the **healthcare workforce**.
...
- Before beginning the communication, identify conditions and situations that may be relevant to the populations and scenarios discussed (e.g., illness, disease, living situation, sexual activity or identity, gender identity, language, ethnicity, citizenship status):
  ...
  - **Exceptions apply:**
    ...
    - Certain groups may prefer identity-first language. Per the American Psychological Association (APA) [^4], in these cases it is permissible to use either a person-first or identity-first phrasing, or a mix, until the group clearly states a preference for one approach.
...
- Use gender-inclusive occupational nouns such as "chair" or "chairperson" [^6].
- Use gender as an adjective, not a noun (e.g., "female person").
- When referring to someone with a pronoun, use the singular gender-neutral (they/them) [^4], unless it is demonstrably necessary to differentiate.
- Use "gender" and "sex assigned at birth" classifications appropriately:
  - Gender refers to a person's social identity.
  - In general, avoid "sex" or "sex assigned at birth." When demonstrably necessary to the project, apply person-first phrasing, such as "people who were raised female/male" [^7].
  - As of the writing of this guide, "transgender" and "gender nonconforming" are generally agreed-upon terms [^7].
- Avoid assumptions and apply phrasing consistently. For example, if you refer to people who are transgender, include the corollary ("people who are cisgender") [^7].
...
- Capitalize the names of races, ethnicities, and tribes [^5].
...
| Resource |
|---|
| CDC Preferred Terms for Select Population Groups and Communities [^3] |
| AAFP |
| Agency for Healthcare Research and Quality Priority Populations |
| American Psychological Association -- APA Style: Bias-Free Language [^4] |
| APA DEI Language Guidelines [^4] |
| Health Resources and Services Administration |
| JAMA Network [^5] |
| NIH Person-First Language [^6] |
| SAGE Publications [^7] |
| SAGE Inclusive Communications [^7] |
...
[^1]: This section is adapted from the methodology handbook published by the Society for Healthcare Epidemiology of America (SHEA), September 2024. Rewritten in original language by The Clinical Database for educational and clinical reference purposes. All standard methodological frameworks referenced herein are independent, publicly available scientific standards.

[^2]: ACCORD guideline for reporting consensus-based methods. Available at: https://www.equator-network.org/reporting-guidelines/accord/

[^3]: CDC Preferred Terms for Select Population Groups and Communities. Centers for Disease Control and Prevention. Available at: https://www.cdc.gov/healthcommunication/Preferred_Terms.html

[^4]: American Psychological Association. APA Style: Bias-Free Language. Available at: https://apastyle.apa.org/style-grammar-guidelines/bias-free-language

[^5]: JAMA Network. Reporting Race and Ethnicity in Medical and Science Journals. Available at: https://jamanetwork.com/journals/jama/fullarticle/2783090

[^6]: NIH. Person-first and destigmatizing language. Available at: https://www.nih.gov/nih-style-guide/person-first-destigmatizing-language

[^7]: SAGE Publications. Inclusive language guidelines. Available at: https://us.sagepub.com/en-us/nam/inclusive-language
