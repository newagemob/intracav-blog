+++
title = "Central Venous Catheters: Types, Indications, and Clinical Safety"
date = 2026-02-25T00:00:00-05:00
lastmod = 2026-02-25T00:00:00-05:00
content_type = "guide"
audience = "clinician"
departments = ["vascular-access"]
category = ["Central Venous Access", "Vascular Access Devices", "Patient Safety"]
tags = ["central venous catheter", "CVC", "CVAD", "tunneled catheter", "implanted port", "hemodialysis catheter", "CVAD tip location", "internal jugular", "subclavian", "vascular access"]
author = ["Dennis Woo", "Dr. Mike Stern", "I.M. Wright"]
description = "Complete clinical reference on central venous catheters: non-tunneled CVCs (IJ, subclavian, femoral), tunneled catheters (Hickman, Broviac, Groshong), implanted ports, dialysis catheters, and CVAD tip location standards."
slug = "central-venous-catheters"
keywords = ["central venous catheter", "CVC types", "non-tunneled CVC", "tunneled central catheter", "implanted port", "CVAD tip location", "CEVAD", "Hickman catheter", "hemodialysis catheter", "internal jugular CVC"]
schema_type = "MedicalWebPage"
pillar = true
pillar_cluster = "central-venous-catheters"
aliases = ["/guides/central-venous-catheters/"]
+++
...
1. Apply sterile probe cover and sterile ultrasound gel
2. Identify target vein (compressible, non-pulsatile) in short-axis view
3. Center vein on screen, guide needle insertion under real-time visualization
4. Confirm wire in vein before catheter insertion (long-axis view of wire, or use of Doppler)

See [Ultrasound-Guided Vascular Access](/vascular-access/guides/ultrasound-guided-vascular-access/) for the complete guide.
...
1. Palpate the port septum and estimate depth
2. Prepare skin with CHG-alcohol antiseptic; allow to dry
3. Don sterile gloves; prepare sterile field
4. Stabilize port with non-dominant hand (two-finger method or dedicated port stabilizer)
5. Insert Huber needle **perpendicular (90°) to the septum** until the needle contacts the back wall of the reservoir
6. Confirm placement by aspirating blood return (brisk blood return expected)
7. Flush with 10 mL normal saline; observe site for swelling
8. Proceed with therapy
...
See [Implanted Vascular Access Ports: Complete Guide](/vascular-access/guides/central-venous-catheters/implanted-port-guide/).
...
See [Hemodialysis Vascular Access](/vascular-access/guides/central-venous-catheters/hemodialysis-vascular-access-guide/) for the complete guide.
...
1. **Post-procedure CXR**: Most widely used. Tip ideally seen at the CAJ (approximately at the level of the right tracheobronchial angle or just below the carina on CXR; 1–2 cm below carina is often cited as a landmark approximation for CAJ).

2. **Intraprocedural ECG guidance (Sherlock 3CG, MIRUS, Nautilus)**: Electrode within the PICC guidewire detects P-wave morphology. As the tip approaches the sinoatrial (SA) node, P-wave amplitude increases; optimal CAJ position is characterized by a P-wave that is approximately 70–85% of the amplitude of the maximum P-wave (just above the peak). Validated accuracy >95%; increasingly becoming standard of care for PICC insertion.

3. **Fluoroscopy**: Gold standard; limited to IR suites or hybrid ORs.

See [CVAD Tip Location Standards](/vascular-access/guides/central-venous-catheters/cvad-tip-location-standards/) for the complete guide.

---

## Related Satellite Guides

- [Non-Tunneled CVC: IJ vs Subclavian vs Femoral](/vascular-access/guides/central-venous-catheters/non-tunneled-cvc-guide/)
- [Tunneled Central Catheters: Hickman, Broviac, Groshong](/vascular-access/guides/central-venous-catheters/tunneled-central-catheters-guide/)
- [Implanted Vascular Access Ports: Complete Guide](/vascular-access/guides/central-venous-catheters/implanted-port-guide/)
- [Hemodialysis Vascular Access: AV Fistula, Graft, and Catheter](/vascular-access/guides/central-venous-catheters/hemodialysis-vascular-access-guide/)
- [CVAD Tip Location Standards: CEVAD and ECG Guidance](/vascular-access/guides/central-venous-catheters/cvad-tip-location-standards/)

## Related Policies

- [Vascular Access Device Selection and Insertion](/vascular-access/policies/vascular-access-device-selection-insertion/)
- [Central Vascular Access Device Tip Location](/vascular-access/policies/central-vascular-access-device-tip-location/)
- [Implanted Vascular Access Ports](/vascular-access/policies/implanted-vascular-access-ports/)
