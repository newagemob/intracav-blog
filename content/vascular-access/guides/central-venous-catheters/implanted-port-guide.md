+++
title = "Implanted Vascular Access Ports: Complete Clinical Guide"
...
description = "Complete clinical guide to implanted vascular access ports: port anatomy, Huber needle access technique, ANTT flushing and locking protocol, power-injectable ports, port complications, and deaccess procedure."
slug = "implanted-port-guide"
keywords = ["implanted vascular access port", "Huber needle technique", "port access procedure", "port flush heparin", "power injectable port", "port complications", "accessing implanted port", "port deaccess technique", "chemotherapy port care"]
aliases = ["/guides/central-venous-catheters/implanted-port-guide/"]
+++
...
| Feature | Implanted Port | PICC | Tunneled CVC |
|---|---|---|---|
| External component | None between accesses | Yes (always visible) | Yes (always visible) |
| Daily access | Needle access required | Direct hub access | Direct hub access |
| CLABSI risk per dwell-day | Lowest | Low-moderate | Low |
| Best for | Intermittent therapy | Daily/continuous therapy | Daily/continuous therapy |
| Swimming | Permitted (no needle) | Contraindicated | Contraindicated |
| Placement | Surgical/IR | Bedside RN/IR | IR/surgery |
| Removal | Surgical/IR | Bedside nursing | IR/surgery |
...
**Related guides:**
- [Tunneled Central Catheters Guide](/vascular-access/guides/central-venous-catheters/tunneled-central-catheters-guide/)
...
**Patient education:**
- [Your Implanted Port: Home Care Guide](/vascular-access/patient-education/implanted-port-home-care/)
