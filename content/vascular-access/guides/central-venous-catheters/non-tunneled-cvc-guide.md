+++
title = "Non-Tunneled Central Venous Catheters: Clinical Guide to Insertion, Use, and Complications"
...
description = "Complete clinical guide to non-tunneled central venous catheters: site selection (IJ vs subclavian vs femoral), ultrasound-guided insertion, complications (pneumothorax, hemothorax, arterial injury), CLABSI prevention, and removal."
slug = "non-tunneled-cvc-guide"
keywords = ["non-tunneled central venous catheter", "CVC insertion technique", "IJ vs subclavian CVC", "femoral central line", "CVC complications", "CVC CLABSI prevention", "ultrasound guided central line", "Seldinger technique central venous catheter"]
aliases = ["/guides/central-venous-catheters/non-tunneled-cvc-guide/"]
+++
...
| Feature | Internal Jugular (IJ) | Subclavian | Femoral |
|---|---|---|---|
| **CLABSI risk** | Intermediate | Lowest | Highest |
| **Pneumothorax risk** | Low (<0.1% with US guidance) | 1–3% (landmark); lower with US | None |
| **Hemothorax risk** | Rare | 0.5–1% | None |
| **Arterial puncture risk** | Moderate (carotid) | Low (subclavian artery) | Moderate (femoral artery) |
| **DVT risk** | Low-moderate | Low | Highest |
| **Access difficulty** | Low-moderate | Moderate | Easy |
| **Ultrasound guidance** | Highly effective (superficial vessel) | Effective but more challenging | Effective (vein visible beside artery) |
...
**Recognition:** Sudden hypoxia, "mill-wheel" murmur, cardiovascular collapse (large air embolism). See [Air Embolism policy](/vascular-access/policies/air-embolism-vascular-access/) for emergency management.

### CLABSI

See [CLABSI Prevention](/vascular-access/guides/clabsi-prevention/) for complete bundle information. Key points for CVCs:
...
**Related guides:**
- [CVAD Tip Location Standards](/vascular-access/guides/central-venous-catheters/cvad-tip-location-standards/)
- [CLABSI Prevention: Complete Reference](/vascular-access/guides/clabsi-prevention/)
- [PICC vs Midline vs CVC Decision Guide](/vascular-access/guides/picc-lines/picc-vs-midline-vs-cvc/)
