+++
title = "Tunneled Central Venous Catheters: Hickman, Broviac, and Groshong Clinical Guide"
date = 2026-02-25T00:00:00-05:00
lastmod = 2026-02-25T00:00:00-05:00
content_type = "guide"
audience = "clinician"
departments = ["vascular-access"]
category = ["Central Venous Catheters", "Tunneled Catheters", "Long-Term Access"]
tags = ["tunneled central catheter", "Hickman catheter", "Broviac catheter", "Groshong catheter", "tunneled CVC care", "Dacron cuff catheter", "long term central access", "home IV tunneled catheter"]
author = ["Dennis Woo", "Dr. Mike Stern", "I.M. Wright"]
description = "Clinical guide to tunneled central venous catheters: Hickman, Broviac, and Groshong types, indications, care and maintenance, flushing protocols, complication management, and comparison with implanted ports."
slug = "tunneled-central-catheters-guide"
keywords = ["tunneled central venous catheter", "Hickman catheter care", "Broviac catheter", "Groshong valve catheter", "tunneled CVC vs port", "long term central venous access", "Dacron cuff tunneled catheter", "tunneled catheter flushing protocol"]
aliases = ["/guides/central-venous-catheters/tunneled-central-catheters-guide/"]
+++
...
**Parent guide:** [Central Venous Catheters: Complete Clinical Reference](/vascular-access/guides/central-venous-catheters/)
...
1. Venous access established at IJ or subclavian vein using standard Seldinger technique under US and fluoroscopy
2. Tunneling device passed subcutaneously from chest exit site to venous entry site
3. Catheter threaded through the tunnel
4. Catheter advanced into SVC; tip positioned at CAJ under fluoroscopic guidance
5. Catheter secured; exit site dressed
...
1. Don sterile gloves; clean exit site with CHG-based antiseptic
2. Inspect exit site: erythema, swelling, tenderness, drainage (quantity, color, character)
3. Inspect tunnel tract (palpate subcutaneously): tenderness, erythema, warmth along tunnel suggest tunnel infection
4. Apply new sterile dressing; secure catheter to prevent tension on exit site
5. Document findings
...
1. Small incision over cuff site
2. Blunt dissection to free the cuff from the fibrous ingrowth
3. Catheter withdrawn from the venous system
4. Exit site and cuff incision closed
...
**Related guides:**
- [Implanted Vascular Access Ports](/vascular-access/guides/central-venous-catheters/implanted-port-guide/)
- [Hemodialysis Vascular Access Guide](/vascular-access/guides/central-venous-catheters/hemodialysis-vascular-access-guide/)
- [CLABSI Prevention](/vascular-access/guides/clabsi-prevention/)
