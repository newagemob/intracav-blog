+++
title = "VA-BC Certification: Complete Guide to Vascular Access Board Certification"
date = 2026-02-25T00:00:00-05:00
lastmod = 2026-02-25T00:00:00-05:00
content_type = "guide"
audience = "clinician"
departments = ["vascular-access"]
category = ["Credentialing", "Certification", "Professional Development"]
tags = ["VA-BC certification", "vascular access board certified", "AVAR certification", "CBVN certification", "vascular access certification exam", "VA-BC eligibility", "VA-BC exam content", "vascular access nurse certification"]
author = ["Dennis Woo", "Dr. Mike Stern", "I.M. Wright"]
description = "Complete guide to VA-BC (Vascular Access Board Certified) certification: eligibility requirements, exam content domains, application process, exam preparation, and recertification requirements through AVAR/CBVN."
slug = "va-bc-certification-guide"
keywords = ["VA-BC certification", "Vascular Access Board Certified", "CBVN vascular access exam", "AVAR certification vascular access", "VA-BC eligibility hours", "vascular access certification exam domains", "VA-BC renewal requirements", "vascular access nurse certification"]
aliases = ["/guides/vascular-access-credentialing/va-bc-certification-guide/"]
+++
...
1. Review current CBVN eligibility criteria at cbvn.net
2. Complete online application; gather supporting documents:
   - Copy of current nursing license
   - Supervisor verification of 1,500+ clinical hours
3. Pay application and exam fee (fees subject to change; AVAR members may receive discounted rate)
4. Receive Authorization to Test (ATT) from Pearson VUE
5. Schedule exam at Pearson VUE center or online
6. Take exam; receive immediate pass/fail result
