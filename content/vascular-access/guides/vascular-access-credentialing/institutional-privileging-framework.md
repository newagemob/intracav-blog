+++
title = "Institutional Privileging for Vascular Access: Building a Defensible Framework"
...
description = "Framework for building an institutional vascular access privileging program: scope of practice delineation, privilege categories, competency documentation, re-privileging, medical staff credentialing vs. nursing competency, and TJC compliance."
slug = "institutional-privileging-framework"
keywords = ["institutional vascular access privileging", "PICC insertion privileges", "clinical privileging vascular access", "vascular access scope of practice delineation", "hospital privileging framework", "PICC competency program institutional", "TJC vascular access credentialing", "privileging vs competency vascular access"]
aliases = ["/guides/vascular-access-credentialing/institutional-privileging-framework/"]
+++
...
**US-guided PIV:** May require a supplemental credentialing record given the specialized skill involved. See [Ultrasound Credentialing Requirements](/vascular-access/guides/ultrasound-guided-vascular-access/ultrasound-credentialing-requirements/).
...
**Annual:**
8. Annual case volume log (procedure counts per year)
9. Annual competency assessment documentation
10. Current license renewal copy
11. Certification renewal documentation
