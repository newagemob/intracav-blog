+++
title = "Infiltration and Extravasation: Clinical Guide to Recognition, Staging, and Treatment"
...
aliases = ["/guides/catheter-complications/infiltration-extravasation-guide/"]
+++
...
**Parent guide:** [Catheter Complications: Complete Clinical Reference](/vascular-access/guides/catheter-complications/)
...
|---|---|---|---|
| **0** | No symptoms | — | Monitor |
| **1** | Blanched skin, cool to touch, edema <1 inch diameter, no pain | Pale, cool skin at site | Discontinue IV; elevate; consider warm compress |
| **2** | Blanched skin, edema 1–6 inches, cool to touch, with or without pain | Moderate swelling | Discontinue IV; elevate; warm compress; reassess in 1 hour |
| **3** | Blanched skin, translucent skin, edema >6 inches; gross edema with or without pitting; skin cool; mild-moderate pain; possible numbness | Significant swelling; blistering possible | Discontinue IV; elevate; notify provider; document |
| **4** | Skin tight, leaking; skin discolored, bruised, swollen; indented; gross edema; deep pitting tissue edema; circulatory impairment; moderate to severe pain; infiltration of any amount of blood product, irritant, or vesicant | Severe injury; potential necrosis | **Emergency response** (see below); provider notification immediately; antidote if vesicant |
...
| Vesicant Category | Antidote | Dose and Route | Notes |
|---|---|---|---|
...
| **Vinca alkaloids** (vincristine, vinblastine) | **Hyaluronidase** | 1–6 mL of 150 units/mL; inject SQ around extravasation site | Inject within 1 hour; multiple SQ injections in a clockwise pattern around the periphery of the extravasation area |
| **Taxanes** (paclitaxel, docetaxel) | Hyaluronidase | Same as vinca alkaloids | Apply cold compress after antidote |
| **Vasopressors** (norepinephrine, dopamine, phenylephrine) | **Phentolamine** | 5–10 mg diluted in 10 mL NS; inject SQ in extravasation area within 12 hours | Alpha-adrenergic blocker reverses vasopressor-induced ischemia; inject within 12 hours for effect; monitor for hypotension |
| **Concentrated KCl, calcium** | Hyaluronidase | As above | Supportive; wound care |
...
**Primary prevention: Use central access for all vesicant infusions.** All chemotherapy vesicants and concentrated vasoactive infusions should be administered via a central catheter (PICC, CVC, or port) to minimize extravasation risk. See [Evidence-Based Device Selection](/vascular-access/guides/vascular-access/evidence-based-device-selection/) for osmolarity and pH thresholds.
...
**Related guides:**
- [Phlebitis Recognition and Management](/vascular-access/guides/catheter-complications/phlebitis-recognition-management/)
- [Evidence-Based Device Selection](/vascular-access/guides/vascular-access/evidence-based-device-selection/)

**Related policies:**
- [Infiltration and Extravasation Management](/vascular-access/policies/infiltration-extravasation-management/)
