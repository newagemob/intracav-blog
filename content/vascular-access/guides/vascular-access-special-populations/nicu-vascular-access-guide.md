+++
title = "NICU Vascular Access: Umbilical Catheters, Neonatal PICC, and Peripheral IV in Neonates"
...
description = "Complete NICU vascular access guide: umbilical arterial and venous catheters (UAC/UVC), neonatal PICC lines, neonatal peripheral IV, gestational age considerations, skin protection, heparin-free protocols, and light protection for neonatal PN."
slug = "nicu-vascular-access-guide"
keywords = ["NICU vascular access guide", "umbilical arterial catheter", "umbilical venous catheter", "neonatal PICC line", "neonatal peripheral IV access", "UAC tip position", "UVC tip position", "preterm infant IV access"]
aliases = ["/guides/vascular-access-special-populations/nicu-vascular-access-guide/"]
+++
...
1. Prepare umbilical stump: cut cord 1–2 cm from skin; identify the single large-lumen umbilical vein (thin-walled, oval or irregular) and two smaller arterial vessels (round, thick-walled)
2. Insert catheter to estimated depth (birth weight in kg + 1 + 1 = estimated UVC depth in cm — more precise estimates use body length/shoulder-umbilicus measurements)
3. Confirm with radiograph before use
4. Do not advance/withdraw without radiographic confirmation if catheter has been in use
5. Secure with suture/umbilical bridge; bridge securement preferred over tape
...
1. Dorsum of hand
2. Dorsum of foot
3. Forearm (cephalic/basilic)
4. Antecubital fossa (avoid in neonates when possible — positional instability)
5. Scalp veins (frontal, temporal) — last resort for peripheral access in neonates
...
**Related guides:**
- [Pediatric Peripheral IV Guide](/vascular-access/guides/vascular-access-special-populations/pediatric-peripheral-iv-guide/)
- [Infusion Filtration Guide](/vascular-access/guides/infusion-therapy-safety/infusion-filtration-guide/)
- [Parenteral Nutrition and Vascular Access](/vascular-access/guides/infusion-therapy-safety/parenteral-nutrition-vascular-access/)
