+++
title = "Critical Care Vascular Access: ICU Device Selection, Arterial Lines, and High-Acuity Protocols"
...
description = "Clinical guide to critical care vascular access: CVC site selection in the ICU, arterial line placement and management, vasopressor central access requirements, CRRT/CVVHD access, pulmonary artery catheter, CLABSI prevention in the ICU, and simultaneous multi-device management in the critically ill."
slug = "critical-care-vascular-access-guide"
keywords = ["critical care vascular access guide", "ICU CVC site selection", "arterial line ICU placement", "vasopressor central access requirement", "CRRT vascular access", "ICU CLABSI prevention", "pulmonary artery catheter", "critical care IV access"]
aliases = ["/guides/vascular-access-special-populations/critical-care-vascular-access-guide/"]
+++
...
**Parent guide:** [Vascular Access Special Populations: Complete Reference](/vascular-access/guides/vascular-access-special-populations/)
...
1. **Subclavian vein (first choice for CLABSI prevention):** Lowest CLABSI rate among non-tunneled CVC insertion sites in meta-analyses. However, highest risk of pneumothorax (1–3%); not suitable in patients with coagulopathy, emphysematous bullae near the apex, or contralateral pneumothorax.

2. **Internal jugular (IJ) vein (second choice):** Lower pneumothorax risk than subclavian. Higher CLABSI rate than subclavian. Preferred when coagulopathy is present (site is compressible if arterial injury occurs). Right IJ is most direct path to SVC/RA.

3. **Femoral vein (avoid when possible):** Highest CLABSI rate; highest DVT rate; access site contamination with perineal/fecal flora. **Avoid femoral access** unless upper body access is impossible. If femoral CVC is placed emergently, plan for earliest possible replacement with IJ or subclavian access.
...
1. Position wrist in dorsiflexion with support roll under wrist; sterile prep with CHG/IPA
2. Palpate radial artery at 1.5 cm proximal to the radial styloid
3. Insert 20G IV catheter at 30–45° angle; advance until flash of blood in hub
4. Lower angle and advance catheter while withdrawing needle
5. Connect transducer tubing; confirm arterial waveform (pulsatile, systolic > diastolic)
6. Secure catheter; apply transparent dressing
7. **Do not aspirate from arterial line without first disconnecting from pressure transducer** — aspiration against a pressurized system can draw air into the line
...
**Related guides:**
- [Non-Tunneled CVC Guide](/vascular-access/guides/central-venous-catheters/non-tunneled-cvc-guide/)
- [CLABSI Insertion Bundle](/vascular-access/guides/clabsi-prevention/clabsi-insertion-bundle/)
- [CLABSI Maintenance Bundle](/vascular-access/guides/clabsi-prevention/clabsi-maintenance-bundle/)
- [Vesicant Administration Safety](/vascular-access/guides/infusion-therapy-safety/vesicant-administration-safety/)
- [Vascular Access Special Populations](/vascular-access/guides/vascular-access-special-populations/)
...
5. Ricard JD, et al. (2013). Subclavian or internal jugular central venous catheter — which is more efficient? *Crit Care Med*, 41(7):1760–1765.
6. Loubani OM & Green RS. (2015). A systematic review of extravasation and local tissue injury from administration of vasopressors through peripheral intravenous catheters. *J Crit Care*, 30(3):653.e9–653.e17.
