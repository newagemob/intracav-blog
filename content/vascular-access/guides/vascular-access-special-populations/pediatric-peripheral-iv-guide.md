+++
title = "Pediatric Peripheral IV Access: Age-Specific Technique, Site Selection, and Pain Management"
...
description = "Complete guide to pediatric peripheral IV access: age-specific site selection (neonate to adolescent), scalp vein placement in infants, pain management (EMLA, LMX, vapocoolant, sucrose), gauge selection, restraint considerations, and family-centered care."
slug = "pediatric-peripheral-iv-guide"
keywords = ["pediatric peripheral IV placement", "pediatric IV site selection age", "infant scalp vein IV", "EMLA cream pediatric IV", "pediatric IV pain management", "child IV placement technique", "pediatric vascular access guide", "saphenous vein pediatric IV"]
aliases = ["/guides/vascular-access-special-populations/pediatric-peripheral-iv-guide/"]
+++
...
| Age Group | Standard Gauge | Large-Bore Need |
|---|---|---|
| Neonate | 24G or 26G | 22G for blood products |
| Infant (1–12 months) | 24G | 22G if large vein available |
| Toddler/Preschool (1–5 years) | 22G or 24G | 20G for rapid fluid resuscitation |
| School-age (6–12 years) | 22G | 20G |
| Adolescent (13–17 years) | 20–22G | 18G for rapid transfusion |

---

## Pain Management: Evidence Summary

| Intervention | Onset | Duration | Best For |
|---|---|---|---|
| EMLA (lidocaine/prilocaine) | 45–60 min | 1–2 hours | Scheduled procedures; infants >37 weeks; >2 months |
| LMX 4 (liposomal lidocaine) | 30 min | 30–45 min | Slightly faster than EMLA; similar age range |
| Vapocoolant spray | Immediate (3–7 sec) | Brief | Urgent/unplanned access; useful as adjunct |
| Oral sucrose 24% | 2 min | 10–15 min | Neonates and infants ≤6 months |
| Non-nutritive sucking | Immediate | During procedure | Neonates; enhanced with sucrose |
| Distraction (child life) | Immediate | During procedure | All ages; highly effective |
| Parental presence | Immediate | Throughout | All ages; reduces distress |
| Nitrous oxide | 5 min | During use | Selected settings with nitrous availability |
...
**Related guides:**
- [NICU Vascular Access Guide](/vascular-access/guides/vascular-access-special-populations/nicu-vascular-access-guide/)
- [Vascular Access Special Populations](/vascular-access/guides/vascular-access-special-populations/)

**Patient education:**
- [Parent Guide: NICU Vascular Access](/vascular-access/patient-education/nicu-vascular-access-parent-guide/)
