+++
title = "Oncology Vascular Access: Port Placement, Chemotherapy Access Requirements, and Immunocompromised Considerations"
...
description = "Comprehensive guide to oncology vascular access: port vs PICC decision-making, chemotherapy central access requirements, vesicant administration, CLABSI prevention in neutropenic patients, power-injectable port selection, and access management across the cancer treatment continuum."
slug = "oncology-vascular-access-guide"
keywords = ["oncology vascular access guide", "port vs PICC chemotherapy", "chemotherapy central line requirements", "implanted port cancer patient", "CLABSI neutropenic patient", "vesicant central access requirement", "power injectable port CT contrast", "cancer vascular access clinical guide"]
aliases = ["/guides/vascular-access-special-populations/oncology-vascular-access-guide/"]
+++
...
See [Vesicant Administration Safety](/vascular-access/guides/infusion-therapy-safety/vesicant-administration-safety/) for complete vesicant protocol.
...
1. **Neutropenia:** Absolute neutrophil count (ANC) <500 cells/μL markedly impairs bacterial clearance; even low-level catheter colonization can cause life-threatening bacteremia in a neutropenic patient
2. **Mucosal barrier disruption:** Chemotherapy-induced mucositis disrupts the gut barrier, creating bacteremia risk from translocation of gut flora — some CLABSI cases are secondary to gut-origin organisms
3. **Frequent catheter access:** Chemotherapy protocols involve frequent hub manipulations (blood draws, pre-medications, chemotherapy administration, post-hydration)
4. **Steroid use:** Corticosteroids (dexamethasone as antiemetic; prednisone in lymphoma protocols) impair innate immunity
5. **Central venous malignancy:** Tumor invasion or compression near catheter tip can impair blood flow and create local infection niche
...
**Related guides:**
- [Implanted Port Guide](/vascular-access/guides/central-venous-catheters/implanted-port-guide/)
- [Vesicant Administration Safety](/vascular-access/guides/infusion-therapy-safety/vesicant-administration-safety/)
- [PICC Complications Prevention](/vascular-access/guides/picc-lines/picc-complications-prevention/)
...
**Patient education:**
- [Chemotherapy and Your Central Line](/vascular-access/patient-education/chemotherapy-and-your-central-line/)
- [Outpatient Infusion: What to Expect](/vascular-access/patient-education/outpatient-infusion-what-to-expect/)
- [Living with an Implanted Port](/vascular-access/patient-education/living-with-implanted-port/)
...
5. Schiffer CA, et al. (2018). Central venous catheter care for the oncology patient. *J Clin Oncol*, 31(10):1357–1370.
