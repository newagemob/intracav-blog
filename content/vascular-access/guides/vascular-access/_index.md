+++
title = "Vascular Access: The Complete Clinical Reference"
...
aliases = ["/guides/vascular-access/"]
+++
...
This guide covers the complete spectrum: device types and selection principles, relevant clinical standards, complication prevention, documentation requirements, and quality metrics. Use the navigation links to explore focused satellite guides on each topic.
...
See [Catheter Complications: Recognition and Management](/vascular-access/guides/catheter-complications/) and [CLABSI Prevention Framework](/vascular-access/guides/clabsi-prevention/) for full coverage.
...
See [Vascular Access Documentation Requirements](/vascular-access/guides/vascular-access/vascular-access-documentation-requirements/) for the complete guide.
...
See the full [Vascular Access Team Models guide](/vascular-access/guides/vascular-access-team-models/) for building, measuring, and governing a VAT program.
...
- [PICC Lines: Complete Clinical Reference](/vascular-access/guides/picc-lines/)
- [Central Venous Catheters: Types, Indications, and Safety](/vascular-access/guides/central-venous-catheters/)
- [CLABSI Prevention: Evidence-Based Bundle Framework](/vascular-access/guides/clabsi-prevention/)
- [Catheter Complications: Recognition and Management](/vascular-access/guides/catheter-complications/)
- [Ultrasound-Guided Vascular Access](/vascular-access/guides/ultrasound-guided-vascular-access/)
- [Vascular Access Credentialing and Certification](/vascular-access/guides/vascular-access-credentialing/)
- [Infusion Therapy Safety](/vascular-access/guides/infusion-therapy-safety/)
- [Vascular Access in Special Populations](/vascular-access/guides/vascular-access-special-populations/)
- [Vascular Access Team Models](/vascular-access/guides/vascular-access-team-models/)

---

## Related Policies

This guide is supported by the following institutional policy references:
...
- [Documentation: Health Record — Vascular Access](/vascular-access/policies/documentation-health-record-vascular-access/)
- [Quality Improvement — Vascular Access](/vascular-access/policies/quality-improvement-vascular-access/)
...
- [CLABSI Prevention Framework (Printable)](/vascular-access/resources/clabsi-prevention-framework/)
