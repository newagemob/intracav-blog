+++
title = "Vascular Access Device Types: A Complete Comparison Guide"
...
description = "Complete comparison of all vascular access device types: PIV, midline, PICC, CVC, tunneled catheter, port, hemodialysis catheter, IO, and arterial line — with a clinical selection guide."
slug = "vascular-access-device-types-comparison"
keywords = ["types of vascular access devices", "PIV vs PICC comparison", "midline vs PICC", "PICC vs CVC", "implanted port comparison", "vascular access device selection guide", "peripheral IV comparison"]
aliases = ["/guides/vascular-access/vascular-access-device-types-comparison/"]
+++
...
**Appropriate for:** IV therapy ≥5–7 days requiring central access, OPAT, TPN, chemotherapy, vesicants, multi-lumen needs. See [PICC Line Indications](/vascular-access/guides/picc-lines/picc-line-indications/).
