+++
title = "CLABSI Definition, Epidemiology, and Surveillance: What Clinicians Need to Know"
date = 2026-02-25T00:00:00-05:00
lastmod = 2026-02-25T00:00:00-05:00
content_type = "guide"
audience = "clinician"
departments = ["vascular-access", "infection-prevention"]
category = ["CLABSI Prevention", "Infection Control", "Epidemiology"]
tags = ["CLABSI definition", "CLABSI epidemiology", "NHSN CLABSI", "CLABSI vs CRBSI", "central line infection surveillance", "CLABSI incidence", "CLABSI mortality", "CLABSI SIR"]
author = ["Dennis Woo", "Dr. Mike Stern", "I.M. Wright"]
description = "Complete overview of CLABSI definition (NHSN criteria), epidemiology (incidence, mortality, cost), CLABSI vs CRBSI distinction, NHSN surveillance methodology, SIR benchmarking, and how CLABSI rates are calculated."
slug = "clabsi-definition-epidemiology"
keywords = ["CLABSI definition NHSN", "CLABSI incidence rate", "CLABSI mortality", "CLABSI cost", "NHSN central line infection", "CLABSI vs CRBSI", "central line associated bloodstream infection", "CLABSI SIR", "CLABSI catheter days"]
aliases = ["/guides/clabsi-prevention/clabsi-definition-epidemiology/"]
+++
...
**Example:** ICU with 500 central line-days and 2 CLABSI events:
CLABSI rate = (2 / 500) × 1,000 = **4.0 per 1,000 central line-days**
