+++
title = "Chlorhexidine Gluconate (CHG) in CLABSI Prevention: Evidence and Clinical Application"
date = 2026-02-25T00:00:00-05:00
lastmod = 2026-02-25T00:00:00-05:00
content_type = "guide"
audience = "clinician"
departments = ["vascular-access", "infection-prevention"]
category = ["CLABSI Prevention", "Infection Control", "Antisepsis"]
tags = ["chlorhexidine gluconate CLABSI", "CHG antisepsis", "CHG bathing", "CHG dressing", "2% CHG vascular access", "CHG vs povidone iodine", "CHG skin prep", "CHG impregnated dressing"]
author = ["Dennis Woo", "Dr. Mike Stern", "I.M. Wright"]
description = "Evidence-based guide to chlorhexidine gluconate (CHG) in CLABSI prevention: skin antisepsis (2% CHG vs povidone-iodine), CHG-impregnated dressings, daily CHG bathing, application technique, dry time requirements, and CHG safety considerations."
slug = "chlorhexidine-gluconate-clabsi"
keywords = ["chlorhexidine gluconate CLABSI prevention", "CHG skin antisepsis central line", "CHG impregnated dressing", "CHG bathing CLABSI", "2% CHG IPA skin prep", "CHG vs povidone iodine central line", "CHG dry time vascular access", "CHG safety neonates"]
aliases = ["/guides/clabsi-prevention/chlorhexidine-gluconate-clabsi/"]
+++
