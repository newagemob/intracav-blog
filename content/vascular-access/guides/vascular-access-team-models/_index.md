+++
title = "Vascular Access Team Models: Building and Measuring a VAT Program"
date = 2026-02-25T00:00:00-05:00
lastmod = 2026-02-25T00:00:00-05:00
content_type = "guide"
audience = "clinician"
departments = ["vascular-access"]
category = ["Vascular Access Teams", "Service Delivery", "Quality Improvement", "Healthcare Administration"]
tags = ["vascular access team", "VAT program", "PICC team", "vascular access service delivery", "VAT evidence", "VAT ROI", "vascular access quality metrics", "VAT implementation", "IV team"]
author = ["Dennis Woo", "Dr. Mike Stern", "I.M. Wright"]
description = "Complete guide to building, measuring, and governing a vascular access team (VAT) program: models, evidence, ROI calculation, quality metrics, scope of practice, and program governance."
slug = "vascular-access-team-models"
keywords = ["vascular access team", "VAT program", "building a PICC team", "vascular access team evidence", "VAT ROI", "vascular access quality metrics", "vascular access service model", "IV team evidence", "PICC team implementation"]
schema_type = "MedicalWebPage"
pillar = true
pillar_cluster = "vascular-access-team-models"
aliases = ["/guides/vascular-access-team-models/"]
+++
...
- **The Clinical Database**: Clinical policy reference, evidence-based guides, and competency tools supporting VAT program operations — see [The Clinical Database Vascular Access Knowledge Center](/vascular-access/guides/)

---

## Related Satellite Guides

- [The Business Case for a Vascular Access Team: Evidence and ROI](/vascular-access/guides/vascular-access-team-models/vascular-access-team-evidence-roi/)
- [Quality Metrics for Vascular Access Programs](/vascular-access/guides/vascular-access-team-models/vascular-access-quality-metrics/)

## Related Policies

- [Service Delivery Models and Operational Scope](/vascular-access/policies/service-delivery-models-operational-scope/)
- [Quality Improvement in Vascular Access](/vascular-access/policies/quality-improvement-vascular-access/)
- [Strategic Planning and Implementation of Vascular Access Services](/vascular-access/policies/strategic-planning-implementation-vascular-access-services/)
...
5. Keogh S, et al. (2019). Long-term outcomes of peripheral intravenous catheters. *J Infus Nurs*, 42(4):198–206.
