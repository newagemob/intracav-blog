+++
title = "Ultrasound-Guided Peripheral IV for Difficult Access: DIVA Score and Technique"
date = 2026-02-25T00:00:00-05:00
lastmod = 2026-02-25T00:00:00-05:00
content_type = "guide"
audience = "clinician"
departments = ["vascular-access", "ed"]
category = ["Ultrasound-Guided Access", "Peripheral IV", "Difficult Access"]
tags = ["ultrasound guided peripheral IV", "difficult IV access", "DIVA score", "US PIV technique", "difficult venous access", "ultrasound PIV placement", "DIVA criteria", "long catheter US PIV"]
author = ["Dennis Woo", "Dr. Mike Stern", "I.M. Wright"]
description = "Guide to ultrasound-guided peripheral IV for difficult venous access: DIVA score application, vein selection (diameter, depth), catheter length requirements, short-axis technique, common pitfalls, and when to escalate to midline or PICC."
slug = "ultrasound-peripheral-iv-difficult-access"
keywords = ["ultrasound guided peripheral IV", "difficult IV access DIVA score", "US guided PIV technique", "long catheter peripheral IV", "difficult venous access ultrasound", "DIVA criteria peripheral IV", "upper arm peripheral IV ultrasound", "when to escalate PICC vs PIV"]
aliases = ["/guides/ultrasound-guided-vascular-access/ultrasound-peripheral-iv-difficult-access/"]
+++
...
**The "one-third rule" (practical guideline):**
At least one-third of the catheter must remain within the vein after insertion for the catheter to remain intraluminal with normal patient movement. If a vein is 2 cm deep and you use a 1" (2.5 cm) catheter: 1 cm enters the vein, 1.5 cm is in tissue — inadequate retention. For 2 cm deep vein, use a 3-inch (7.5 cm) long-line catheter.
...
See [PICC vs Midline vs CVC Decision Guide](/vascular-access/guides/picc-lines/picc-vs-midline-vs-cvc/) and [Evidence-Based Device Selection](/vascular-access/guides/vascular-access/evidence-based-device-selection/).
