+++
title = "Ultrasound Technique for Vascular Access: Short-Axis, Long-Axis, and Dynamic Guidance"
date = 2026-02-25T00:00:00-05:00
lastmod = 2026-02-25T00:00:00-05:00
content_type = "guide"
audience = "clinician"
departments = ["vascular-access"]
category = ["Ultrasound-Guided Access", "Technique", "Clinical Practice"]
tags = ["ultrasound technique vascular access", "short axis ultrasound", "long axis ultrasound", "dynamic needle guidance", "out of plane ultrasound", "in plane ultrasound", "ultrasound probe technique", "US guided needle visualization"]
author = ["Dennis Woo", "Dr. Mike Stern", "I.M. Wright"]
description = "Comprehensive guide to ultrasound technique for vascular access: probe selection, short-axis vs long-axis approach, in-plane vs out-of-plane needle guidance, dynamic vs static technique, and practical tips for needle visualization."
slug = "ultrasound-technique-vascular-access"
keywords = ["ultrasound technique vascular access", "short axis ultrasound needle guidance", "long axis ultrasound vascular", "in plane out of plane ultrasound", "dynamic ultrasound guided venipuncture", "ultrasound probe selection vascular access", "needle tip visualization ultrasound", "US guided PICC technique"]
aliases = ["/guides/ultrasound-guided-vascular-access/ultrasound-technique-vascular-access/"]
+++
...
1. Open machine, select linear probe, set depth to 2–4 cm for upper arm veins
2. Apply sterile probe cover (for sterile procedures) and sterile gel on insertion field, or non-sterile gel for site assessment
3. Identify target vessel before prepping patient skin
...
- [Ultrasound for Peripheral IV Difficult Access](/vascular-access/guides/ultrasound-guided-vascular-access/ultrasound-peripheral-iv-difficult-access/)
- [Ultrasound for PICC Insertion](/vascular-access/guides/ultrasound-guided-vascular-access/ultrasound-picc-insertion-guide/)
...
1. Troianos CA, et al. (2011). Guidelines for performing ultrasound guided vascular cannulation. *Anesth Analg*, 114(1):46–72.
2. Brass P, et al. (2015). Ultrasound guidance for CVC insertion. *Cochrane Database Syst Rev*, (1):CD011447.
3. NICE Technology Appraisal No. 49. (2002). Guidance on the use of ultrasound locating devices for placing CVC catheters. London: National Institute for Clinical Excellence.
4. Lamperti M, et al. (2012). International evidence-based recommendations on US-guided vascular access. *Intensive Care Med*, 38(7):1105–1117.
