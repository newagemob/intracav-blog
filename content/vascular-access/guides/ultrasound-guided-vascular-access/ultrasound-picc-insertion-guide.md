+++
title = "Ultrasound-Guided PICC Insertion: Complete Procedural Guide"
date = 2026-02-25T00:00:00-05:00
lastmod = 2026-02-25T00:00:00-05:00
content_type = "guide"
audience = "clinician"
departments = ["vascular-access"]
category = ["Ultrasound-Guided Access", "PICC Line", "Insertion Technique"]
tags = ["ultrasound guided PICC", "US PICC insertion", "PICC ultrasound technique", "basilic vein PICC US", "long axis PICC insertion", "PICC vein selection ultrasound", "ultrasound MST PICC", "PICC guidewire ultrasound confirmation"]
author = ["Dennis Woo", "Dr. Mike Stern", "I.M. Wright"]
description = "Complete ultrasound-guided PICC insertion guide: pre-insertion vein survey, long-axis technique for basilic vein cannulation, guidewire US confirmation, catheter measurement, and intraoperative tip guidance with ECG."
slug = "ultrasound-picc-insertion-guide"
keywords = ["ultrasound guided PICC insertion", "US PICC technique", "basilic vein PICC ultrasound", "PICC vein survey pre-insertion", "long axis PICC cannulation", "guidewire confirmation ultrasound", "PICC catheter to vein ratio", "ECG tip confirmation PICC ultrasound"]
aliases = ["/guides/ultrasound-guided-vascular-access/ultrasound-picc-insertion-guide/"]
+++
...
**Parent guide:** [Ultrasound-Guided Vascular Access: Complete Reference](/vascular-access/guides/ultrasound-guided-vascular-access/)
...
1. **Basilic vein** at mid-upper arm: transverse view; measure inner lumen diameter; assess compressibility; check for thrombosis (incompressibility, intraluminal echogenicity)
2. **Brachial veins**: identify adjacent to brachial artery; measure
3. **Cephalic vein**: lateral upper arm; measure
4. **Axillary vein**: scan proximal to the basilic entry point; confirm patency
...
1. Measure the vein inner lumen diameter in transverse view at the planned insertion site
2. Identify the smallest-gauge PICC that meets clinical lumen count requirement
3. Check manufacturer's outer diameter for that catheter
4. Calculate: (Catheter OD / Vein inner diameter) × 100 = catheter-to-vein ratio (%)
5. **Target: ≤45%**

**Example:** 4 Fr double-lumen PICC (outer diameter ~1.7 mm) in a basilic vein measuring 4.5 mm inner diameter:
1.7 / 4.5 × 100 = 38% ✓ (acceptable)
...
**Procedure:**
1. Advance catheter to 2–3 cm short of pre-measured length
2. Activate ECG guidance system; observe P-wave on monitor
3. Slowly advance catheter until P-wave reaches maximum amplitude (equal to or greater than surface lead amplitude)
4. Note catheter position at maximum P-wave; this is the CAJ — confirm external catheter length
5. If P-wave begins to invert: catheter is in the RA — withdraw 1–2 cm
...
**Related guides:**
- [PICC Insertion Technique](/vascular-access/guides/picc-lines/picc-insertion-technique/)
- [PICC Tip Position Verification](/vascular-access/guides/picc-lines/picc-tip-position-verification/)
- [Ultrasound Technique for Vascular Access](/vascular-access/guides/ultrasound-guided-vascular-access/ultrasound-technique-vascular-access/)
- [Vascular Anatomy for Ultrasound-Guided Access](/vascular-access/guides/ultrasound-guided-vascular-access/vascular-anatomy-ultrasound/)

**Related policies:**
- [Vascular Access Device Insertion](/vascular-access/policies/vascular-access-device-insertion/)
- [Vascular Visualization Technology](/vascular-access/policies/vascular-visualization-technology/)
