+++
title = "PICC vs Midline vs CVC: Clinical Decision Guide"
...
aliases = ["/guides/picc-lines/picc-vs-midline-vs-cvc/"]
+++
...
| Feature | Midline Catheter | PICC Line | Non-Tunneled CVC |
|---|---|---|---|
| **Tip location** | Axillary/subclavian (peripheral) | Lower SVC / CAJ (central) | Lower SVC or IVC (central) |
| **Dwell time** | 1–4 weeks | Weeks to months | Days to ~2 weeks |
| **Osmolarity limit** | <600–800 mOsm/L | No limit (central tip) | No limit (central tip) |
| **Vesicants** | Not appropriate | Yes | Yes |
| **TPN** | Not appropriate | Yes | Yes |
| **CLABSI designation** | No (peripheral device) | Yes | Yes |
| **Blood draws** | Per policy; limited | Yes (per protocol) | Yes |
| **Multi-lumen** | 1–2 lumens | Up to 3 lumens | Up to 4 lumens |
| **Insertion approach** | Upper arm, US-guided | Upper arm, US-guided | IJ / subclavian / femoral |
| **Procedural risk** | Low | Low | Moderate (pneumothorax, arterial) |
| **Tip confirmation** | Not required (peripheral) | Required (CXR or ECG) | Required (CXR) |
| **Typical setting** | Med-surg, ambulatory | Med-surg, ICU, OPAT | ICU, ED, acute care |
| **Insertion privileges** | Credentialed RN, APRN | Credentialed RN, APRN, MD | MD, PA, NP with privileges |
...
See [PICC Line Indications](/vascular-access/guides/picc-lines/picc-line-indications/) for full appropriateness criteria including MAGIC.
...
**Related guides:**
- [PICC Line Indications](/vascular-access/guides/picc-lines/picc-line-indications/)
- [Evidence-Based Device Selection](/vascular-access/guides/vascular-access/evidence-based-device-selection/)
- [Vascular Access Device Types: Complete Comparison](/vascular-access/guides/vascular-access/vascular-access-device-types-comparison/)
- [Central Venous Catheters: Complete Reference](/vascular-access/guides/central-venous-catheters/)
