+++
title = "PICC Lines: The Complete Clinical Reference"
date = 2026-02-25T00:00:00-05:00
lastmod = 2026-02-25T00:00:00-05:00
content_type = "guide"
audience = "clinician"
departments = ["vascular-access"]
category = ["PICC Line", "Vascular Access Devices", "Central Venous Access"]
tags = ["PICC line", "peripherally inserted central catheter", "PICC insertion", "PICC complications", "PICC tip position", "PICC care", "PICC dressing", "PICC maintenance", "central venous access", "ultrasound PICC"]
author = ["Dennis Woo", "Dr. Mike Stern", "I.M. Wright"]
description = "The complete clinical reference on PICC lines: indications, ultrasound-guided insertion, CEVAD tip position standards, maintenance protocols, complications, and removal — evidence-based."
slug = "picc-lines"
keywords = ["PICC line", "peripherally inserted central catheter", "PICC insertion", "PICC tip position", "PICC care", "PICC complications", "PICC vs midline", "PICC vs CVC", "CEVAD", "PICC line guide for nurses"]
schema_type = "MedicalWebPage"
pillar = true
pillar_cluster = "picc-lines"
aliases = ["/guides/picc-lines/"]
+++
...
See [PICC Insertion Technique](/vascular-access/guides/picc-lines/picc-insertion-technique/) for the step-by-step procedural guide.
...
See [PICC Tip Position and CEVAD Standards](/vascular-access/guides/picc-lines/picc-tip-position-verification/) for the full guide.
...
See [PICC Care and Maintenance](/vascular-access/guides/picc-lines/picc-care-maintenance/) for the full protocol.
...
See [PICC Complications: Prevention and Management](/vascular-access/guides/picc-lines/picc-complications-prevention/) and [Catheter Complications](/vascular-access/guides/catheter-complications/) for the full management guides.
...
- **Oncology patients**: PICC is appropriate for moderate-duration chemotherapy or OPAT. For long-term or intermittent therapy, implanted port is preferred. See [Oncology Vascular Access](/vascular-access/guides/vascular-access-special-populations/oncology-vascular-access-guide/).
- **Pediatric patients**: PICC sizing, site selection, and tip location calculations differ from adults. See [NICU Vascular Access](/vascular-access/guides/vascular-access-special-populations/nicu-vascular-access-guide/).
...
- [PICC Line Indications: Who Needs a PICC and When](/vascular-access/guides/picc-lines/picc-line-indications/)
- [PICC Insertion Technique: Ultrasound-Guided MST](/vascular-access/guides/picc-lines/picc-insertion-technique/)
- [PICC Tip Position and CEVAD Standards](/vascular-access/guides/picc-lines/picc-tip-position-verification/)
- [PICC vs. Midline vs. CVC: Clinical Decision Guide](/vascular-access/guides/picc-lines/picc-vs-midline-vs-cvc/)
- [PICC Complications: Prevention and Management](/vascular-access/guides/picc-lines/picc-complications-prevention/)
- [PICC Care and Maintenance](/vascular-access/guides/picc-lines/picc-care-maintenance/)
...
- [Vascular Access Device Securement](/vascular-access/policies/vascular-access-device-securement/)
- [Flushing and Locking Vascular Access Devices](/vascular-access/policies/flushing-locking-vascular-access-devices/)
...
- [Going Home with a PICC Line](/vascular-access/patient-education/going-home-with-a-picc-line/)
