+++
title = "PICC Tip Position Verification: ECG Guidance and CXR Confirmation Standards"
date = 2026-02-25T00:00:00-05:00
lastmod = 2026-02-25T00:00:00-05:00
content_type = "guide"
audience = "clinician"
departments = ["vascular-access"]
category = ["PICC Line", "Tip Location", "Clinical Standards"]
tags = ["PICC tip position", "cavoatrial junction", "ECG tip confirmation", "PICC tip verification", "CEVAD tip location", "PICC CXR", "intraprocedural ECG", "PICC malposition"]
author = ["Dennis Woo", "Dr. Mike Stern", "I.M. Wright"]
description = "Evidence-based guide to PICC tip position verification: cavoatrial junction target, intraprocedural ECG guidance (P-wave method), post-procedure CXR interpretation, malposition recognition, and CEVAD standards."
slug = "picc-tip-position-verification"
keywords = ["PICC tip position", "cavoatrial junction PICC", "ECG PICC tip confirmation", "PICC CXR tip location", "CEVAD tip location standards", "PICC malposition recognition", "intraprocedural ECG guidance", "PICC tip too proximal"]
aliases = ["/guides/picc-lines/picc-tip-position-verification/"]
+++
...
| Catheter Tip Location | P-Wave Appearance |
|---|---|
| Proximal SVC | Small, upright P-wave (same as limb lead morphology) |
| Mid-SVC | P-wave begins to increase in amplitude |
| Lower SVC / CAJ | **Maximum upright P-wave** — at least equal to the R-wave amplitude |
| Right atrium | P-wave begins to invert (biphasic, then negative) |
| Right ventricle | Wide QRS, no distinct P-wave |
...
- [Ultrasound-Guided Vascular Access: Complete Reference](/vascular-access/guides/ultrasound-guided-vascular-access/)
...
- [Central Vascular Access Device Malposition](/vascular-access/policies/central-vascular-access-device-malposition/)
