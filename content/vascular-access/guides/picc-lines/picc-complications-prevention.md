+++
title = "PICC Line Complications: Prevention, Recognition, and Management"
date = 2026-02-25T00:00:00-05:00
lastmod = 2026-02-25T00:00:00-05:00
content_type = "guide"
audience = "clinician"
departments = ["vascular-access"]
category = ["PICC Line", "Complications", "Vascular Access Safety"]
tags = ["PICC complications", "PICC DVT prevention", "PICC CLABSI", "PICC occlusion management", "PICC phlebitis", "PICC malposition", "catheter associated thrombosis PICC", "PICC line problems"]
author = ["Dennis Woo", "Dr. Mike Stern", "I.M. Wright"]
description = "Complete guide to PICC line complications: PICC-associated DVT (incidence, prevention, anticoagulation), CLABSI prevention, catheter occlusion (alteplase protocol), phlebitis, mechanical complications, and MARSI prevention."
slug = "picc-complications-prevention"
keywords = ["PICC complications", "PICC DVT incidence", "PICC CLABSI prevention", "PICC occlusion alteplase", "PICC phlebitis", "PICC mechanical complications", "PICC removal complications", "PICC thrombosis anticoagulation"]
aliases = ["/guides/picc-lines/picc-complications-prevention/"]
+++
...
**Parent guide:** [PICC Lines: Complete Clinical Reference](/vascular-access/guides/picc-lines/)
...
| Mechanical complications | 2–5% | US guidance, proper technique | Varies |
| MARSI | Variable | CHG dressing alternatives, proper removal | Non-urgent; escalate if severe |
| Malposition | 1–5% | Proper measurement, arm position during insertion | Remove/reposition before use |
| Air embolism | Rare | Proper removal technique | Emergent |
...
**Action:** Draw blood cultures (peripherally and through PICC), notify provider, assess for PICC removal. Do not remove PICC until blood cultures are drawn. See [Vascular Access Device-Related Infections](/vascular-access/policies/vascular-access-device-related-infections/) for full protocol.
...
| Grade | Signs | Action |
|---|---|---|
| 0 | No symptoms | Continue assessment |
| 1 | Erythema, pain at site with or without edema | Re-site within 24h |
| 2 | Erythema and/or edema; streak formation | Remove catheter; warm compress |
| 3 | Streak formation; palpable venous cord >1 inch | Remove catheter; treat; follow up |
| 4 | Palpable venous cord >1 inch; purulent drainage | Remove catheter; consider antibiotics; wound care |
...
PICC removal carries a specific air embolism risk if Valsalva maneuver precautions are not followed. See [PICC Care and Maintenance](/vascular-access/guides/picc-lines/picc-care-maintenance/) for removal technique.
...
- [Catheter Complications: Complete Reference](/vascular-access/guides/catheter-complications/)

**Related policies:**
- [Catheter-Associated Thrombosis](/vascular-access/policies/catheter-associated-thrombosis/)
- [Vascular Access Device-Related Infections](/vascular-access/policies/vascular-access-device-related-infections/)
- [Catheter Damage, Embolism, Repair, and Exchange](/vascular-access/policies/catheter-damage-embolism-repair-exchange/)
