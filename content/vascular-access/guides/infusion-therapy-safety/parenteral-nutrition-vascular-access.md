+++
title = "Parenteral Nutrition and Vascular Access: Access Requirements and Safe Administration"
date = 2026-02-25T00:00:00-05:00
lastmod = 2026-02-25T00:00:00-05:00
content_type = "guide"
audience = "clinician"
departments = ["vascular-access"]
category = ["Infusion Therapy Safety", "Parenteral Nutrition", "Vascular Access"]
tags = ["parenteral nutrition vascular access", "TPN central access", "PN PICC", "TPN osmolarity access", "PN filtration", "peripheral parenteral nutrition", "TPN PICC central line", "PN administration set"]
author = ["Dennis Woo", "Dr. Mike Stern", "I.M. Wright"]
description = "Guide to vascular access requirements for parenteral nutrition (PN): central vs peripheral PN access criteria, osmolarity thresholds, PICC vs CVC for TPN, dedicated PN lumen, filtration requirements, administration set change intervals, and DEHP-free requirements."
slug = "parenteral-nutrition-vascular-access"
keywords = ["parenteral nutrition vascular access", "TPN central access requirement", "PN osmolarity threshold", "PICC for TPN", "peripheral parenteral nutrition access", "TPN dedicated lumen", "PN filtration 0.22 micron", "PN administration set change TPN"]
aliases = ["/guides/infusion-therapy-safety/parenteral-nutrition-vascular-access/"]
+++
...
**Parent guide:** [Infusion Therapy Safety: Complete Reference](/vascular-access/guides/infusion-therapy-safety/)
...
- [Flushing and Locking SASH Protocol](/vascular-access/guides/infusion-therapy-safety/flushing-locking-sash-protocol/)
- [CLABSI Maintenance Bundle](/vascular-access/guides/clabsi-prevention/clabsi-maintenance-bundle/)

**Related policies:**
- [Parenteral Nutrition Administration](/vascular-access/policies/parenteral-nutrition-administration/)
