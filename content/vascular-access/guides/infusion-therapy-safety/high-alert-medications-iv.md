+++
title = "High-Alert Medications in IV Therapy: Safety Standards and Clinical Protocols"
...
description = "Clinical guide to high-alert IV medications: ISMP list of high-alert medications in vascular access, safety protocols for concentrated KCl, heparin, insulin, opioids, neuromuscular blockers, and chemotherapy — with required safeguards."
slug = "high-alert-medications-iv"
keywords = ["high alert medications IV therapy", "ISMP high alert list intravenous", "IV potassium chloride safety", "heparin infusion safety protocol", "insulin drip safety", "neuromuscular blocking agent IV", "chemotherapy IV safety", "concentrated electrolytes IV access"]
aliases = ["/guides/infusion-therapy-safety/high-alert-medications-iv/"]
+++
...
- **Safe practices:**
  ...
  - See [Patient-Controlled Analgesia policy](/vascular-access/policies/patient-controlled-analgesia/) for full PCA safety framework
...
- **Risk:** Chemotherapy agents have narrow therapeutic windows; overdoses cause life-threatening toxicities. Many are vesicants (see [Vesicant Administration Safety](/vascular-access/guides/infusion-therapy-safety/vesicant-administration-safety/)).
- **Safe practices:**
...
- [Infusion Therapy Safety: Complete Reference](/vascular-access/guides/infusion-therapy-safety/)

**Related policies:**
- [Patient-Controlled Analgesia](/vascular-access/policies/patient-controlled-analgesia/)
- [Controlled Substance Diversion Prevention](/vascular-access/policies/controlled-substance-diversion-prevention/)
