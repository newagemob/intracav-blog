+++
title = "Administration Set Management"
...
description = "Establishes requirements for the appropriate selection, use, configuration, labeling, and replacement of primary and secondary administration sets for all infusion types, including standard solutions, parenteral nutrition, lipids, blood products, propofol, and hemodynamic monitoring systems."
summary = "Formal policy for administration set management covering design requirements, ANTT compliance, replacement intervals by infusion type, special requirements for PN/lipid/propofol/blood, material compatibility, sorption and leaching considerations, labeling standards, system tracing requirements, and quality improvement."
slug = "administration-set-management"
keywords = ["administration set replacement policy", "IV tubing change interval", "parenteral nutrition tubing 24 hours", "blood administration set", "propofol tubing 6-12 hours", "sorption IV tubing", "DEHP free tubing", "luer-lock administration set", "intermittent administration set", "continuous administration set", "anti-free-flow IV"]
authority = "Vascular Access Governance Committee; Pharmacy; Infusion Therapy; Infection Prevention"
effective_date = "2024-05-20"
aliases = ["/policies/administration-set-management/"]
+++
