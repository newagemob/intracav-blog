...
category = ["Clinical Practice", "Product Evaluation", "Patient Safety"]
tags = ["evidence-based practice", "clinical monitoring", "device selection", "vascular access", "site assessment", "patency", "antiseptic selection"]
author = ["Dennis Woo", "Dr. Mike Stern", "I.M. Wright"]
description = "Mandates that all vascular access device selection, antiseptic agent selection, and infusion technology decisions be rooted in demonstrated clinical evidence and patient outcomes, and establishes the systematic clinical monitoring requirements for all vascular access devices."
slug = "evidence-based-selection-clinical-monitoring"
keywords = ["evidence-based decision making", "EBDM", "device selection", "clinical monitoring", "site assessment", "patency", "phlebitis", "infiltration", "extravasation", "conflict of interest"]
authority = "Vascular Access Governance Committee; Product Evaluation Committee"
effective_date = "2026-02-01"
aliases = ["/policies/evidence-based-selection-clinical-monitoring/"]
+++
