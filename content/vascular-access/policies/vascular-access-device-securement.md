+++
title = "Vascular Access Device Securement"
...
description = "Establishes requirements for the securement of all vascular access devices to prevent complications associated with dislodgement and movement at the insertion site, including acceptable securement methods, device-specific guidance, and assessment standards."
summary = "Formal policy for VAD securement covering securement method requirements, definitions of ASD/ISD/SASS/tissue adhesive, avoidance of sutures, bundled approaches, device-specific guidance for PIVC/midline/PICC/CVAD/arterial catheter, subcutaneous anchor systems, skin injury prevention, and dislodged catheter management."
slug = "vascular-access-device-securement"
keywords = ["VAD securement policy", "PICC securement", "PIVC dislodgement prevention", "sutureless securement", "tissue adhesive catheter", "adhesive securement device", "integrated securement device", "subcutaneous anchor PICC", "catheter skin injury prevention", "StatLock SecurAcath"]
authority = "Vascular Access Governance Committee; Clinical Practice; Patient Safety"
effective_date = "2023-09-12"
aliases = ["/policies/vascular-access-device-securement/"]
+++
