+++
title = "Needleless Connectors for Vascular Access Devices"
date = 2023-06-20T00:00:00-05:00
lastmod = 2025-05-12T00:00:00-05:00
content_type = "policies"
audience = "clinician"
departments = ["vascular-access", "infection-prevention"]
category = ["Infection Prevention", "Vascular Access Management", "Patient Safety"]
tags = ["needleless connector", "disinfection", "CLABSI prevention", "hub care", "passive disinfection cap", "scrub the hub", "ANTT", "reflux", "needleless connector change", "flushing sequence"]
author = ["Dennis Woo", "Dr. Mike Stern", "I.M. Wright"]
description = "Establishes requirements for selection, disinfection, flushing and clamping sequences, replacement intervals, and infection prevention practices for all needleless connectors used on peripheral and central vascular access devices."
summary = "Formal policy for needleless connector management covering connector selection criteria, fluid displacement classification, disinfection methods (active and passive), scrubbing technique, drying times, antimicrobial connectors, replacement triggers, manifold management, and compliance monitoring."
slug = "needleless-connectors"
keywords = ["needleless connector policy", "hub disinfection", "scrub the hub", "CLABSI prevention needleless connector", "passive disinfection cap", "connector flushing sequence", "needleless connector replacement", "infection prevention VAD", "chlorhexidine hub cap"]
authority = "Vascular Access Governance Committee; Infection Prevention; Patient Safety"
effective_date = "2023-06-20"
aliases = ["/policies/needleless-connectors/"]
+++
