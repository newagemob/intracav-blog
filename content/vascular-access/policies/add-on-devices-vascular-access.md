+++
title = "Add-On Devices for Vascular Access Systems"
...
description = "Establishes requirements for the selection, use, configuration, disinfection, and replacement of add-on devices in vascular access infusion systems, including extension sets, manifolds, stopcocks, filters, and closed system transfer devices."
summary = "Formal policy for add-on device management covering clinical indication requirements, luer-lock compatibility, device burden minimization, stopcock configuration, filtration considerations, infusion accuracy impact, disinfection requirements, and replacement standards."
slug = "add-on-devices-vascular-access"
keywords = ["add-on devices VAD policy", "extension set", "stopcock", "manifold", "infusion system safety", "luer-lock", "CSTD hazardous drug", "add-on device replacement", "in-line filter", "infusion accuracy"]
authority = "Vascular Access Governance Committee; Pharmacy; Infusion Therapy; Patient Safety"
effective_date = "2024-03-05"
aliases = ["/policies/add-on-devices-vascular-access/"]
+++
