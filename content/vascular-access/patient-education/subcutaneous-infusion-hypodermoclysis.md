+++
title = "Subcutaneous Infusion (Hypodermoclysis): What to Expect"
date = 2026-02-23T00:00:00-05:00
lastmod = 2026-02-23T00:00:00-05:00
content_type = "patient-education"
audience = "patient"
departments = ["vascular-access"]
category = ["Home Care", "Palliative Care", "Patient Education", "Procedures"]
tags = ["hypodermoclysis", "subcutaneous infusion", "subcut IV", "subcutaneous fluids", "subcutaneous medication delivery", "palliative IV access", "home hydration", "butterfly needle under skin"]
author = ["Dennis Woo", "Dr. Mike Stern", "I.M. Wright"]
description = "A patient guide to subcutaneous infusion (hypodermoclysis) — delivering fluids and medications under the skin instead of into a vein. How it works, who it's for, what can be given, site care, and what to expect."
slug = "subcutaneous-infusion-hypodermoclysis"
keywords = ["subcutaneous infusion patient guide", "hypodermoclysis what to expect", "fluids under skin instead of IV", "subcut fluids palliative care", "subcutaneous medication delivery home", "butterfly needle subcutaneous infusion"]
authority = "Vascular Access Governance Committee; Palliative Care; Patient Education Department"
effective_date = "2026-02-23"
aliases = ["/patient-education/subcutaneous-infusion-hypodermoclysis/"]
+++
...
| Site | Notes |
|------|-------|
| Anterior thigh | Excellent; comfortable; good absorption; recommended first-line |
| Abdomen | Very accessible; good absorption; avoid area around navel |
| Upper outer arm | Good for patients who are mobile; nurse or carer must reach it |
| Chest wall (subclavicular area) | Common in palliative care; allows patient freedom of movement |
| Back / flank | Option when other sites are limited |
...
- [Vascular Access and Goals of Care](/vascular-access/patient-education/vascular-access-goals-of-care/)
