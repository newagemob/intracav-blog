+++
title = "Dialysis Vascular Access: AV Fistulas, Grafts, and Catheters"
...
category = ["Dialysis", "Vascular Access Basics", "Device Care"]
tags = ["dialysis", "AV fistula", "AV graft", "dialysis catheter", "hemodialysis", "fistula care", "graft care", "vascular access dialysis"]
author = ["Dennis Woo", "Dr. Mike Stern", "I.M. Wright"]
description = "A complete patient guide to dialysis vascular access — understanding AV fistulas, AV grafts, and tunneled dialysis catheters, how to care for each, what warning signs to watch for, and how to protect your access long-term."
slug = "dialysis-vascular-access"
keywords = ["AV fistula care patient guide", "dialysis access patient education", "hemodialysis fistula", "AV graft patient guide", "tunneled dialysis catheter", "checking fistula thrill", "protecting dialysis access"]
authority = "Vascular Access Governance Committee; Nephrology; Patient Education Department"
effective_date = "2026-02-23"
aliases = ["/patient-education/dialysis-vascular-access/"]
+++
...
**How to check:**
1. Place two fingers gently over the fistula (the area of the enlarged vein you can feel in your arm).
2. You should feel a continuous, gentle buzzing or vibration — this is the thrill. It should be present 24 hours a day, 7 days a week.
3. You can also listen: place your ear or a stethoscope lightly over the fistula. You should hear a low, continuous swishing sound — the bruit.
...
2. Clamp the catheter lumen if a clamp is accessible.
3. Cover the open end with a clean cloth (do not let it dangle in the air).
4. Call your dialysis center or go to the ER immediately.
