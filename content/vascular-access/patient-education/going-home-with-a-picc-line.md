+++
title = "Going Home with a PICC Line: Your Complete Care Guide"
...
category = ["Home Care", "Device Care", "PICC Line"]
tags = ["PICC line", "home care", "PICC dressing", "PICC flushing", "home infusion", "discharge", "PICC complications", "outpatient IV"]
author = ["Dennis Woo", "Dr. Mike Stern", "I.M. Wright"]
description = "A complete patient guide to going home with a PICC line — dressing care, flushing, bathing, activity, recognizing problems, when to call for help, and home infusion therapy."
slug = "going-home-with-a-picc-line"
keywords = ["PICC line home care", "how to care for PICC at home", "PICC dressing change at home", "flushing PICC line", "PICC line shower", "PICC line activity restrictions", "PICC line complications home"]
authority = "Vascular Access Governance Committee; Home Infusion; Patient Education Department"
effective_date = "2026-02-23"
aliases = ["/patient-education/going-home-with-a-picc-line/"]
+++
...
**Before every use:**
Flush with saline first to confirm the line is open and to clear any residue.

**After every use:**
Flush with saline after each infusion or blood draw. Follow with heparin if prescribed. Use the **SASH** technique when heparin is involved:
- **S** — Saline flush
...
**When not in use:**
Flush on the schedule your team provides — typically every 24 hours for saline-only PICCs, and per specific instructions for heparin-locked PICCs.

### How to flush (general steps)

Your nurse will demonstrate this specifically, but the general process is:

1. Wash your hands thoroughly with soap and water (at least 20 seconds) and dry completely.
2. Gather supplies: pre-filled saline flush syringe (10 mL, as instructed) and/or heparin flush syringe, alcohol wipes or CHG-alcohol wipes.
3. Scrub the cap (the small connector at the end of each PICC lumen) vigorously with an alcohol wipe — typically 15 seconds of scrubbing, then allow to air dry for 15 seconds. This is called "scrub the hub."
4. Attach the saline syringe to the cap by twisting it clockwise.
5. Gently push the saline into the line using a slow, smooth push. Do **not** force the flush if you feel significant resistance — stop and call your home care nurse.
6. Complete the flush using a positive pressure technique as instructed.
7. Detach the syringe.
8. Repeat for the second lumen if you have a double-lumen PICC.
9. Repeat with the heparin syringe if prescribed.
...
**Can I drive with a PICC?**
Yes, in most cases. The PICC arm itself does not prevent driving. However, if your underlying condition or medications affect your ability to drive safely, follow your doctor's guidance on this separately.

**What if I wake up and the dressing is peeled off?**
Call your home care nurse immediately. Do not attempt to re-dress the site with non-sterile tape or supplies. A sterile dressing change is needed as soon as possible.

**What if I accidentally pull the line partially out?**
Do not push it back in. Keep the area clean, cover loosely with gauze if available, call your home infusion nurse, and go to a facility if directed. Bring the catheter with you.

**Can I work or go to school with a PICC?**
Many people do. Discuss your specific situation with your care team, particularly if your job involves heavy physical labor, exposure to water, or a high-infection-risk environment.

**How will I know when my PICC is no longer needed?**
Your physician will determine when your treatment course is complete based on your clinical progress, lab results, and the nature of your infection or condition. Your PICC will be removed as soon as it is no longer medically necessary.
...
- [Understanding Vascular Access](/vascular-access/patient-education/understanding-vascular-access/)
- [Types of IV Lines and Catheters](/vascular-access/patient-education/types-of-iv-lines-and-catheters/)
- [Keeping Your IV Safe: Infection Prevention](/vascular-access/patient-education/keeping-your-iv-safe-infection-prevention/)
- [Recognizing Complications: When to Call for Help](/vascular-access/patient-education/recognizing-complications-when-to-call/)
- [Discharge Planning: Leaving the Hospital with an IV Device](/vascular-access/patient-education/discharge-planning-iv-device/)
- [Preparing for PICC Placement](/vascular-access/patient-education/preparing-for-picc-placement/)
- [Skin Care Around Your Catheter Site](/vascular-access/patient-education/skin-care-around-catheter-site/)
- [Emergency Room Visit When You Have a Catheter](/vascular-access/patient-education/er-visit-with-a-catheter/)
- [PICC Removal: What to Expect](/vascular-access/patient-education/picc-removal-what-to-expect/)
