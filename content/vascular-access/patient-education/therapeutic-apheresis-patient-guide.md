+++
title = "Therapeutic Apheresis: What to Expect"
date = 2026-02-23T00:00:00-05:00
lastmod = 2026-02-23T00:00:00-05:00
content_type = "patient-education"
audience = "patient"
departments = ["vascular-access"]
category = ["Procedures", "Specialty Therapy", "Patient Education"]
tags = ["therapeutic apheresis", "plasmapheresis patient", "therapeutic plasma exchange", "LDL apheresis", "red cell exchange", "photopheresis ECP", "apheresis vascular access", "apheresis catheter"]
author = ["Dennis Woo", "Dr. Mike Stern", "I.M. Wright"]
description = "A patient guide to therapeutic apheresis — what it is, the different types (therapeutic plasma exchange, LDL apheresis, red cell exchange, photopheresis), what vascular access is needed, what to expect during the procedure, and how to manage side effects."
slug = "therapeutic-apheresis-patient-guide"
keywords = ["therapeutic apheresis patient guide", "plasmapheresis what to expect", "therapeutic plasma exchange explained", "apheresis catheter vascular access", "LDL apheresis procedure", "apheresis side effects patient"]
authority = "Vascular Access Governance Committee; Transfusion Medicine; Patient Education Department"
effective_date = "2026-02-23"
aliases = ["/patient-education/therapeutic-apheresis-patient-guide/"]
+++
...
**Advantages:** No catheter placement procedure; access via standard needle sticks.
**Disadvantages:** Not suitable for all patients; can be difficult in patients with small or fragile veins; uncomfortable for repeated procedures.
...
**Where placed:** Internal jugular vein (neck), subclavian vein (chest), or femoral vein (groin) — depending on clinical factors and urgency.
**How placed:** By an interventional radiologist or intensivist under ultrasound guidance, typically at the bedside or in a procedural suite. Local anesthesia is used.
**Duration:** Days to weeks. Not intended for long-term use.
...
**See:** [Going Home with a Tunneled Catheter](/vascular-access/patient-education/going-home-with-a-tunneled-catheter/) for detailed care guidance.
...
|-------------|------------|------------|
| Citrate reaction (tingling, numbness) | Very common | Tell your nurse; calcium is given |
| Fatigue after the session | Common | Rest; resolves within 24 hours |
| Feeling cold during procedure | Common | Blankets |
| Mild hypotension (low blood pressure) | Occasional | Nurse monitors; fluid adjustment |
| Allergic reaction to replacement fluid (albumin or FFP) | Uncommon | Nurse monitors; treated immediately |
| Access site bruising or bleeding | Occasional | Pressure; report if significant |
| Infection at catheter site (for catheter access) | Uncommon | Preventable with proper care |
| Air embolism | Rare | Machine safety systems prevent this |
...
- [Going Home with a Tunneled Catheter](/vascular-access/patient-education/going-home-with-a-tunneled-catheter/)
- [Dialysis and Vascular Access: Fistulas, Grafts, and Catheters](/vascular-access/patient-education/dialysis-vascular-access/)
- [Your First Visit to an Outpatient Infusion Center](/vascular-access/patient-education/outpatient-infusion-center-first-visit/)
