+++
title = "Exercise and Physical Activity with a Vascular Access Device"
date = 2026-02-23T00:00:00-05:00
lastmod = 2026-02-23T00:00:00-05:00
content_type = "patient-education"
audience = "patient"
departments = ["vascular-access"]
category = ["Lifestyle", "Device Care", "Patient Education"]
tags = ["exercise with PICC", "activity with catheter", "PICC activity restrictions", "port exercise", "physical activity IV therapy", "catheter activity", "swimming with catheter"]
author = ["Dennis Woo", "Dr. Mike Stern", "I.M. Wright"]
description = "What patients can and cannot do physically while living with a vascular access device — activity guidelines by device type, returning to exercise after catheter placement, sports and swimming, and why staying active matters."
slug = "exercise-and-activity-with-a-catheter"
keywords = ["exercise with PICC line", "activity restrictions PICC", "can I exercise with a port", "swimming with catheter", "gym with PICC", "physical activity central line", "sports with vascular access device"]
authority = "Vascular Access Governance Committee; Patient Education Department"
effective_date = "2026-02-23"
aliases = ["/patient-education/exercise-and-activity-with-a-catheter/"]
+++
...
**When not infusing:**
No specific activity restrictions from the IV itself. The IV is typically in place for only a few days; resume normal activities.
