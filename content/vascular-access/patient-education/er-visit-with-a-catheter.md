...
category = ["Safety", "Emergency Care", "Patient Education"]
tags = ["ER visit catheter", "emergency room PICC", "emergency room port", "central line ER", "patient advocacy ER", "catheter emergency care"]
author = ["Dennis Woo", "Dr. Mike Stern", "I.M. Wright"]
description = "What patients with vascular access devices need to know when visiting the emergency room — what to tell triage, how to protect your catheter, what ER staff may want to do, how to advocate for your device, and what to bring."
slug = "er-visit-with-a-catheter"
keywords = ["ER visit with PICC line", "emergency room with port", "central line emergency room", "protect PICC in ER", "catheter patient advocacy ER", "what to tell ER triage catheter"]
authority = "Vascular Access Governance Committee; Emergency Medicine; Patient Education Department"
effective_date = "2026-02-23"
aliases = ["/patient-education/er-visit-with-a-catheter/"]
+++
...
> I have a [PICC line in my right/left arm / implanted port in my chest / Hickman catheter in my chest].
> Currently receiving: [medication name]
> NO BP or needles in my [right/left] arm.
> Port access requires Huber needle only.
> My physician: [Name] [Phone number]
> Allergies: [List]
...
- [Chemotherapy Infusion: What to Expect](/vascular-access/patient-education/chemotherapy-infusion-patient-guide/)
...
- [Home TPN: Your Complete Guide](/vascular-access/patient-education/home-tpn-guide/)
- [OPAT: Outpatient IV Antibiotics at Home](/vascular-access/patient-education/opat-patient-guide/)
