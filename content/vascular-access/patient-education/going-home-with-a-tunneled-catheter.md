+++
title = "Going Home with a Tunneled Catheter (Hickman, Broviac, Groshong)"
...
category = ["Home Care", "Device Care", "Tunneled Catheter"]
tags = ["tunneled catheter", "Hickman", "Broviac", "Groshong", "home care", "long-term catheter", "exit site care", "cuff healing"]
author = ["Dennis Woo", "Dr. Mike Stern", "I.M. Wright"]
description = "A complete patient guide to living with a tunneled central venous catheter — Hickman, Broviac, or Groshong — including exit site care, dressing changes, flushing differences by catheter type, activity, bathing, complications, and long-term management."
slug = "going-home-with-a-tunneled-catheter"
keywords = ["Hickman catheter care", "Broviac catheter home care", "Groshong catheter flushing", "tunneled catheter exit site care", "long-term central line home care", "tunneled catheter complications patient guide"]
authority = "Vascular Access Governance Committee; Patient Education Department"
effective_date = "2026-02-23"
aliases = ["/patient-education/going-home-with-a-tunneled-catheter/"]
+++
...
1. **Stability:** A small felt ring on the catheter called a **Dacron cuff** is positioned inside the tunnel. Over the first 2–4 weeks after placement, your body's tissue grows into this cuff, anchoring the catheter securely without stitches.

2. **Infection protection:** The tunnel creates a physical barrier that makes it much harder for bacteria from the skin surface to travel along the catheter into the bloodstream.
...
1. Wash hands.
2. Scrub the hub (needleless connector) with an alcohol wipe — 15 seconds scrub, 15 seconds air dry.
3. For Hickman/Broviac: confirm the clamp is closed before connecting.
4. Twist the connector firmly clockwise to secure.
5. For Hickman/Broviac: open the clamp after connecting.

When disconnecting:
1. For Hickman/Broviac: complete the final saline (and heparin) flush, then **clamp while still pushing the final few drops** of the flush (positive pressure technique). Then disconnect.
2. For Groshong: complete the flush, then disconnect.
3. Ensure a new sterile cap is attached if the old one was removed.
...
- [Travel with a Vascular Access Device](/vascular-access/patient-education/travel-with-a-vascular-access-device/)
- [Your Interventional Radiology Visit](/vascular-access/patient-education/interventional-radiology-visit-guide/)
