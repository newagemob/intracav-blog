+++
title = "Travel with a Vascular Access Device: A Practical Guide"
date = 2026-02-23T00:00:00-05:00
lastmod = 2026-02-23T00:00:00-05:00
content_type = "patient-education"
audience = "patient"
departments = ["vascular-access"]
category = ["Lifestyle", "Home Care", "Patient Education"]
tags = ["travel with PICC", "travel with port", "flying with catheter", "TSA medical device", "traveling on IV therapy", "home infusion travel", "PICC travel tips"]
author = ["Dennis Woo", "Dr. Mike Stern", "I.M. Wright"]
description = "A practical guide to traveling with a vascular access device — flying with a PICC or port, managing medications and supplies on the road, TSA and airport security, international travel, time zone management, and finding emergency care away from home."
slug = "travel-with-a-vascular-access-device"
keywords = ["traveling with PICC line", "flying with port-a-cath", "TSA catheter medical device", "travel with IV antibiotics", "international travel with catheter", "vacation with PICC port", "medication refrigeration travel"]
authority = "Vascular Access Governance Committee; Patient Education Department"
effective_date = "2026-02-23"
aliases = ["/patient-education/travel-with-a-vascular-access-device/"]
+++
...
**Requesting a modified screening:**
You have the right to request a **pat-down instead of the body scanner** if you prefer. Request this before entering the scanner. You may also request:
...
**For IV supplies and medications in carry-on baggage:**
The 3-1-1 liquids rule (3.4 oz / 100 mL containers) does **not apply to medically necessary liquids.** IV bags, flush syringes, and liquid medications are permitted in carry-on bags in quantities exceeding 3.4 oz when they are medically necessary. However:
...
- [Going Home with a Midline Catheter](/vascular-access/patient-education/going-home-with-a-midline-catheter/)
