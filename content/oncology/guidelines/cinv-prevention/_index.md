+++
title = "Chemotherapy-Induced Nausea and Vomiting (CINV): A Comprehensive Prevention and Management Guideline"
description = "Evidence-based guideline for emetogenic risk classification, antiemetic regimen selection, and management of chemotherapy-induced nausea and vomiting."
...
tags = ["CINV", "antiemetics", "ondansetron", "aprepitant", "olanzapine", "emetogenic-risk", "chemotherapy-nausea"]
keywords = ["CINV prevention", "chemotherapy nausea management", "antiemetic guidelines", "emetogenic classification"]
aliases = ["/guidelines/oncology/cinv-prevention/"]
+++
...
| Part | Title | Coverage |
|---|---|---|
| [Part 1](/oncology/guidelines/cinv-prevention/part-1-emetogenic-classification-risk-factors/) | Emetogenic Classification and Risk Factors | Complete emetogenic classification of intravenous and oral chemotherapy agents (high, moderate, low, minimal); types of CINV (acute, delayed, anticipatory, breakthrough, refractory); patient-related and treatment-related risk factors; pathophysiology of chemotherapy-induced emesis |
| [Part 2](/oncology/guidelines/cinv-prevention/part-2-antiemetic-agents/) | Antiemetic Agents: Pharmacology, Dosing, and Adverse Effects | NK1 receptor antagonists; 5-HT3 receptor antagonists; corticosteroids; olanzapine; dopamine receptor antagonists; benzodiazepines; cannabinoids; mechanism of action, dosing, drug interactions, and side effect profiles for each agent class |
| [Part 3](/oncology/guidelines/cinv-prevention/part-3-recommended-regimens-special-populations/) | Recommended Antiemetic Regimens and Special Populations | Guideline-recommended regimens by emetogenic risk level; multi-day chemotherapy protocols; oral chemotherapy-induced CINV; radiation-induced nausea and vomiting (RINV); breakthrough and refractory CINV management; pediatric, geriatric, and organ-impaired populations |
| [Part 4](/oncology/guidelines/cinv-prevention/part-4-assessment-implementation-nonpharmacologic/) | Assessment Tools, Non-Pharmacological Interventions, and Implementation | CTCAE grading; MASCC Antiemesis Tool (MAT); patient assessment and monitoring; non-pharmacological interventions; guideline implementation and quality improvement; patient education |
