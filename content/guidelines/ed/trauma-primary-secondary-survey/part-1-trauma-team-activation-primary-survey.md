+++
title = "Trauma Primary and Secondary Survey — Part 1: Trauma Team Activation & Primary Survey (ABCDE)"
description = "Two-tier trauma team activation criteria, CDC field triage, and complete ABCDE primary survey including airway with C-spine protection, breathing and ventilation, circulation with hemorrhage control, disability assessment with GCS, and exposure/environment."
...
- The national recommended target: **over-triage rate of ≤ 25-35%** and **under-triage rate of ≤ 5%**[^2]
...
| Parameter | Threshold |
|---|---|
| Systolic blood pressure | < 90 mmHg at any point in the field or ED |
| Respiratory rate | < 10 or > 29 breaths/min (< 20 in infants < 1 year) |
| Glasgow Coma Scale (GCS) | ≤ 8 (with mechanism attributed to trauma) |
| Respiratory compromise/need for intubation | Emergent airway required |
| Transfer patients receiving blood to maintain vital signs | Active hemorrhage or hemodynamic instability |
...
| Flail chest | Identified in the field or on arrival |
| Two or more proximal long bone fractures | Femur, humerus |
| Crushed, degloved, or mangled extremity | Including traumatic amputation proximal to wrist/ankle |
| Pelvic fracture | Suspected unstable pelvic fracture |
| Open or depressed skull fracture | |
| Paralysis | Any acute neurologic deficit |
...
| Mechanism | Threshold |
|---|---|
| Motor vehicle crash | High-speed (> 40 mph / 64 km/h), rollover, ejection, death of occupant in same vehicle, significant intrusion (> 12 inches occupant side, > 18 inches any side) |
| Auto vs. pedestrian/bicyclist | Thrown, run over, or significant impact (> 20 mph / 32 km/h) |
| Motorcycle crash | > 20 mph / 32 km/h |
| Fall | Adults: > 20 feet (6 meters); Children: > 10 feet (3 meters) or 2-3 times height |
| Blast injury | Any significant blast exposure |

**Special Considerations Criteria:**

| Consideration | Detail |
|---|---|
| Age | Adults > 55 years; Children < 5 years |
| Anticoagulation | Patients on warfarin, DOACs, clopidogrel, or other anticoagulant/antiplatelet therapy |
| Pregnancy | > 20 weeks gestation |
| Burns | > 20% TBSA or with inhalation injury |
| EMS provider judgment | Paramedic concern for significant injury |
...
| Letter | Component | Goal |
|---|---|---|
| **A** | Airway with cervical spine protection | Establish a patent airway while maintaining C-spine immobilization |
| **B** | Breathing and ventilation | Identify and treat life-threatening thoracic injuries |
| **C** | Circulation with hemorrhage control | Identify and control hemorrhage; restore circulating volume |
| **D** | Disability (neurologic status) | Rapid neurologic assessment |
| **E** | Exposure / Environmental control | Fully expose patient; prevent hypothermia |
...
| Maneuver | Technique | Notes |
|---|---|---|
| **Jaw thrust** | Place fingers behind the angle of the mandible bilaterally and lift anteriorly | Preferred in trauma — does not require cervical extension; use instead of head-tilt chin-lift |
| **Chin lift** | Grasp the mandible at the symphysis and lift anteriorly | Can be performed with cervical precautions but jaw thrust is preferred |
| **Suction** | Rigid Yankauer suction to clear blood, vomitus, secretions | Perform immediately if airway contaminated |
| **Manual debris removal** | Direct removal of visible foreign bodies (teeth, debris) | Use Magill forceps under direct visualization |
...
|---|---|
| **Airway protection** | GCS ≤ 8; inability to protect airway from aspiration (absent gag reflex, massive facial trauma); expanding neck hematoma |
| **Ventilatory failure** | Apnea; inadequate respiratory effort; severe chest wall injury (flail chest with respiratory failure); smoke inhalation with progressive airway edema |
| **Oxygenation failure** | Refractory hypoxemia despite supplemental oxygen (SpO2 < 90% despite high-flow O2) |
| **Anticipated clinical course** | Need for emergent operative intervention; need for CT scanning in an agitated patient who cannot be managed otherwise; transfer to another facility with anticipated airway compromise en route |
| **Combativeness/agitation** | Due to hypoxia or traumatic brain injury, precluding appropriate evaluation and management |

### 3.6 Rapid Sequence Intubation (RSI)

RSI is the technique of choice for definitive airway management in the trauma patient. A detailed discussion of RSI pharmacology, technique, and difficult airway algorithms is provided in the **Airway Management and RSI guideline** (cross-reference: [Airway Management & RSI](/guidelines/ed/airway-management-rsi/)).[^8]
...
- **Video laryngoscopy** is recommended as the first-line technique in trauma to optimize first-pass success while maintaining cervical immobilization[^8]
...
| Finding | Detail |
|---|---|
| Respiratory distress | Tachypnea, dyspnea, agitation |
| Absent breath sounds | On the affected side |
| Hyperresonance to percussion | On the affected side |
| Jugular venous distension | May be absent in concurrent hypovolemia |
| Tracheal deviation | Away from the affected side (late sign; often difficult to detect clinically) |
| Hypotension | Due to decreased venous return; may progress rapidly to cardiac arrest (PEA) |
...
| Site | Technique |
|---|---|
| **2nd intercostal space (ICS), midclavicular line (MCL)** | Traditional landmark; insert a large-bore (14-gauge minimum) needle/angiocatheter over the superior border of the 3rd rib to avoid the intercostal neurovascular bundle running along the inferior border of the 2nd rib |
| **4th or 5th ICS, anterior axillary line (AAL)** | **Preferred site** in current recommendations due to shorter chest wall thickness at this location (particularly in obese patients and muscular individuals, where the 2nd ICS MCL may be too thick for standard-length catheters to reach the pleural space); insert over the superior border of the rib below |
...
| Finding | Detail |
|---|---|
| Shock | Tachycardia, hypotension (due to blood loss) |
| Absent breath sounds | On the affected side |
| Dullness to percussion | On the affected side (distinguishes from tension pneumothorax, which is hyperresonant) |
| Flat neck veins | Due to hypovolemia (in contrast to tension pneumothorax, which may cause JVD) |
...
5. **Surgical fixation of rib fractures** — increasingly performed for patients with flail chest who require mechanical ventilation or have severe chest wall deformity; evidence suggests reduced duration of mechanical ventilation and ICU stay[^11]
...
|---|---|
| **Level of consciousness** | Restlessness, agitation, confusion, or obtundation may indicate cerebral hypoperfusion |
| **Skin color and temperature** | Ashen, gray, or mottled skin with cool extremities suggests hypovolemic shock; warm and pink suggests adequate perfusion |
| **Pulse** | Tachycardia (> 100 bpm) is an early sign of hemorrhage; thready, weak peripheral pulses suggest significant volume loss; absent peripheral pulses with palpable central pulses suggests SBP approximately 60-70 mmHg |
| **Blood pressure** | Hypotension (SBP < 90 mmHg) is a late sign in young adults who can compensate with vasoconstriction and tachycardia; in the elderly, "normal" SBP may represent significant hypotension due to baseline hypertension |
| **Capillary refill** | > 2 seconds suggests hypoperfusion (unreliable in hypothermia or ambient cold) |
...
| Source | Estimated Potential Volume | Assessment |
|---|---|---|
| **External** ("blood on the floor") | Variable — can be massive | Visual inspection and direct pressure |
| **Chest** (hemothorax) | Each hemithorax can hold > 2-3 liters | Decreased breath sounds, dullness; chest X-ray; chest tube |
| **Abdomen** (hemoperitoneum) | Peritoneal cavity can hold the entire blood volume | FAST exam (free fluid); CT; abdominal distension may be a late sign |
| **Pelvis / retroperitoneum** | Pelvic fractures can result in > 3-4 liters of blood loss | Pelvic instability on exam; pelvic X-ray; pelvic binder |
| **Long bones** (femur, humerus) | Each femur fracture: 1-2 liters; humerus: 500-750 mL | Deformity, swelling, instability |

### 5.3 Hemorrhage Control Techniques

#### 5.3.1 Direct Pressure

The first and most fundamental technique for external hemorrhage control. Apply firm, direct pressure with gauze directly to the wound. If initial gauze becomes saturated, do **not** remove it — add additional layers on top and maintain pressure.[^1]
...
- Hemostatic agents significantly improve hemorrhage control in junctional wounds compared to standard gauze[^13]
...
- **Leave in place** until definitive fixation or angiographic embolization is planned[^15]
...
|---|---|---|
| **Adults without TBI** | 80-90 mmHg | Or MAP 50-60 mmHg; or presence of a palpable radial pulse |
| **Adults with TBI** | ≥ 100 mmHg (or MAP ≥ 80 mmHg) | Hypotension must be avoided in TBI due to the devastating effect on secondary brain injury; a single episode of SBP < 90 mmHg doubles mortality in TBI |
| **Elderly patients** | Higher thresholds considered | Due to reduced physiologic reserve and chronic hypertension |
...
| SBP ≤ 90 mmHg in the ED | 1 |
| Heart rate ≥ 120 bpm in the ED | 1 |
| Positive FAST | 1 |
...
|---|---|---|
| **Right upper quadrant (RUQ)** | Hepatorenal recess (Morrison's pouch) | Free fluid between the liver and right kidney — the most gravity-dependent space in the supine patient and the most sensitive single view |
| **Left upper quadrant (LUQ)** | Splenorenal recess | Free fluid between the spleen and left kidney; also check above the spleen (subphrenic space) |
| **Suprapubic / Pelvis** | Posterior to the bladder (rectovesical pouch in males; Pouch of Douglas in females) | Free fluid in the pelvis — the most dependent location in the supine patient |
| **Subxiphoid / Subcostal** | Pericardial space | Pericardial effusion / hemopericardium (cardiac tamponade) |
...
| Zone | Anatomic Location | Indication |
|---|---|---|
| **Zone 1** | Descending thoracic aorta (between the left subclavian artery and the celiac trunk) | Intra-abdominal hemorrhage |
| **Zone 3** | Infrarenal aorta (below the renal arteries and above the aortic bifurcation) | Pelvic/junctional hemorrhage |
| **Zone 2** | Paravisceral aorta (between celiac trunk and renal arteries) | **NOT** a target for balloon occlusion — risk of mesenteric and renal ischemia |
...
| | To voice/speech — eyes open in response to verbal command/speech (not necessarily to command) | 3 |
| | To pressure/pain — eyes open in response to pressure applied to the fingertip, trapezius, or supraorbital ridge | 2 |
| | None — no eye opening despite adequate stimulation | 1 |
| | Not testable (NT) — eyes closed due to local factor (e.g., periorbital swelling) | NT |
| **Verbal Response (V)** | | |
| | Oriented — knows who they are, where they are, the date/time | 5 |
| | Confused — responds in conversational speech but disoriented to person, place, or time | 4 |
| | Inappropriate words — random or exclamatory single words, no sustained conversational exchange | 3 |
| | Incomprehensible sounds — moaning, groaning; no recognizable words | 2 |
| | None — no verbal response despite adequate stimulation | 1 |
| | Not testable (NT) — intubated, tracheostomy, or other factor preventing verbal assessment | NT |
| **Motor Response (M)** | | |
| | Obeys commands — performs requested movements (e.g., "hold up two fingers," "wiggle your toes") | 6 |
| | Localizes pain — purposeful movement toward the stimulus to remove it (e.g., reaches across midline to remove trapezius pinch) | 5 |
| | Withdrawal (flexion) — pulls extremity away from painful stimulus in a normal flexion pattern | 4 |
| | Abnormal flexion (decorticate) — stereotypical flexion of the arm at the elbow and wrist with internal rotation of the shoulder; lower extremities extend | 3 |
| | Extension (decerebrate) — extension and internal rotation of the upper extremity with wrist pronation and finger flexion; lower extremities extend | 2 |
| | None — no motor response despite adequate stimulation | 1 |
| | Not testable (NT) — paralyzed, sedated, or other factor | NT |

**Total GCS = E + V + M** (Range: 3-15)

#### GCS Severity Classification

| GCS Score | Severity Category | Clinical Significance |
|---|---|---|
| 13-15 | Mild | Usually alert and oriented or mildly confused; risk of intracranial injury still present (especially GCS 13) |
| 9-12 | Moderate | Significantly impaired consciousness; warrants CT imaging and close monitoring; may require intubation for airway protection |
| 3-8 | Severe | Coma; **defines severe TBI**; definitive airway required (GCS ≤ 8 = intubate); high risk of intracranial mass lesion; neurosurgical consultation mandatory |
...
- **Pupil reactivity score:** A modification to improve prognostic accuracy subtracts the pupil reactivity score (PRS) from the GCS total: both reactive = 0, one reactive = 1, neither reactive = 2. The GCS-Pupils score (GCS-P) = GCS - PRS, yielding a range of 1-15.[^22]

### 6.3 Pupil Assessment

| Finding | Significance |
|---|---|
| **Unilateral fixed, dilated pupil (> 4 mm, non-reactive)** | Ipsilateral uncal herniation compressing cranial nerve III — this is a neurosurgical emergency requiring emergent CT and likely operative intervention |
| **Bilateral fixed, dilated pupils** | Bilateral herniation, severe brainstem injury, or global hypoxia; may also occur with hypothermia, atropine administration, or direct orbital trauma |
| **Unilateral constricted (miotic) pupil** | Horner's syndrome (sympathetic chain disruption — consider carotid artery injury or cervical spine injury) |
| **Bilateral constricted pupils** | Opioid effect, pontine lesion |
| **Unequal but both reactive** | Physiologic anisocoria (present in ~20% of the population; difference usually < 1 mm); compare to pre-existing records if available |
...
Obtain a point-of-care glucose measurement in all trauma patients with altered mental status. Hypoglycemia (glucose < 60 mg/dL) should be treated immediately with IV dextrose (25-50 mL of D50W in adults, 2-4 mL/kg of D25W in children, 5 mL/kg of D10W in neonates).[^1]
...
[^2]: American College of Surgeons. "Resources for Optimal Care of the Injured Patient." 6th ed. Chicago: ACS; 2014. URL: [https://www.facs.org/quality-programs/trauma/quality/verification-review-and-consultation-program/standards/](https://www.facs.org/quality-programs/trauma/quality/verification-review-and-consultation-program/standards/)

[^3]: Sasser SM, Hunt RC, Faul M, et al. "Guidelines for Field Triage of Injured Patients: Recommendations of the National Expert Panel on Field Triage, 2011." *MMWR Recomm Rep*. 2012;61(RR-1):1-20. URL: [https://www.cdc.gov/mmwr/preview/mmwrhtml/rr6101a1.htm](https://www.cdc.gov/mmwr/preview/mmwrhtml/rr6101a1.htm)

[^4]: Newgard CD, Fischer PE, Guyette FX, et al. "2021 National Guideline for the Field Triage of Injured Patients: Recommendations of the National Expert Panel on Field Triage." *Prehosp Emerg Care*. 2022;26(sup1):1-35. DOI: [10.1080/10903127.2021.2018076](https://doi.org/10.1080/10903127.2021.2018076)

[^5]: National Institute for Health and Care Excellence. "Major Trauma: Assessment and Initial Management (NG39)." London: NICE; 2016 (updated 2023). URL: [https://www.nice.org.uk/guidance/ng39](https://www.nice.org.uk/guidance/ng39)

[^6]: Mock C, Lormand JD, Goosen J, Joshipura M, Peden M. *Guidelines for Essential Trauma Care*. Geneva: World Health Organization; 2004. URL: [https://www.who.int/publications/i/item/guidelines-for-essential-trauma-care](https://www.who.int/publications/i/item/guidelines-for-essential-trauma-care)

[^7]: Patel MB, Humble SS, Cullinane DC, et al. "Cervical Spine Collar Clearance in the Obtunded Adult Blunt Trauma Patient: A Systematic Review and Practice Management Guideline from the Eastern Association for the Surgery of Trauma." *J Trauma Acute Care Surg*. 2015;78(2):430-441. DOI: [10.1097/TA.0000000000000503](https://doi.org/10.1097/TA.0000000000000503)

[^8]: Higgs A, McGrath BA, Goddard C, et al. "Guidelines for the Management of Tracheal Intubation in Critically Ill Adults." *Br J Anaesth*. 2018;120(2):323-352. DOI: [10.1016/j.bja.2017.10.021](https://doi.org/10.1016/j.bja.2017.10.021)

[^9]: Mancini MC, Demetriades D. "Thoracic Trauma." In: Mattox KL, Moore EE, Feliciano DV, eds. *Trauma*. 9th ed. New York: McGraw-Hill; 2021.
...
[^11]: Pieracci FM, Majercik S, Ali-Osman F, et al. "Consensus Statement: Surgical Stabilization of Rib Fractures — An Eastern Association for the Surgery of Trauma Practice Management Guideline." *J Trauma Acute Care Surg*. 2017;82(3):618-626. DOI: [10.1097/TA.0000000000001345](https://doi.org/10.1097/TA.0000000000001345)

[^12]: Cannon JW, Khan MA, Raja AS, et al. "Damage Control Resuscitation in Patients with Severe Traumatic Hemorrhage: A Practice Management Guideline from the Eastern Association for the Surgery of Trauma." *J Trauma Acute Care Surg*. 2017;82(3):605-617. DOI: [10.1097/TA.0000000000001333](https://doi.org/10.1097/TA.0000000000001333)

[^13]: Bulger EM, Snyder D, Schoelles K, et al. "An Evidence-Based Prehospital Guideline for External Hemorrhage Control: American College of Surgeons Committee on Trauma." *Prehosp Emerg Care*. 2014;18(2):163-173. DOI: [10.3109/10903127.2014.896962](https://doi.org/10.3109/10903127.2014.896962)

[^14]: Kragh JF Jr, Walters TJ, Baer DG, et al. "Survival with Emergency Tourniquet Use to Stop Bleeding in Major Limb Trauma." *Ann Surg*. 2009;249(1):1-7. DOI: [10.1097/SLA.0b013e31818842ba](https://doi.org/10.1097/SLA.0b013e31818842ba)

[^15]: Cullinane DC, Schiller HJ, Zielinski MD, et al. "Eastern Association for the Surgery of Trauma Practice Management Guidelines for Hemorrhage in Pelvic Fracture — Update and Systematic Review." *J Trauma*. 2011;71(6):1850-1868. DOI: [10.1097/TA.0b013e31823dca9a](https://doi.org/10.1097/TA.0b013e31823dca9a)

[^16]: Bickell WH, Wall MJ Jr, Pepe PE, et al. "Immediate versus Delayed Fluid Resuscitation for Hypotensive Patients with Penetrating Torso Injuries." *N Engl J Med*. 1994;331(17):1105-1109. DOI: [10.1056/NEJM199410273311701](https://doi.org/10.1056/NEJM199410273311701)

[^17]: Holcomb JB, Tilley BC, Baraniuk S, et al. "Transfusion of Plasma, Platelets, and Red Blood Cells in a 1:1:1 vs a 1:1:2 Ratio and Mortality in Patients with Severe Trauma: The PROPPR Randomized Clinical Trial." *JAMA*. 2015;313(5):471-482. DOI: [10.1001/jama.2015.12](https://doi.org/10.1001/jama.2015.12)

[^18]: Nunez TC, Voskresensky IV, Dossett LA, et al. "Early Prediction of Massive Transfusion in Trauma: Simple as ABC (Assessment of Blood Consumption)?" *J Trauma*. 2009;66(2):346-352. DOI: [10.1097/TA.0b013e3181961c35](https://doi.org/10.1097/TA.0b013e3181961c35)

[^19]: Stengel D, Bauwens K, Sehouli J, et al. "Systematic Review and Meta-Analysis of Emergency Ultrasonography for Blunt Abdominal Trauma." *Br J Surg*. 2001;88(7):901-912. DOI: [10.1046/j.0007-1323.2001.01777.x](https://doi.org/10.1046/j.0007-1323.2001.01777.x)

[^20]: Brenner M, Inaba K, Aiolfi A, et al. "Resuscitative Endovascular Balloon Occlusion of the Aorta and Resuscitative Thoracotomy in Select Patients with Hemorrhagic Shock: Early Results from the American Association for the Surgery of Trauma's Aortic Occlusion in Resuscitation for Trauma and Acute Care Surgery Registry." *J Am Coll Surg*. 2018;226(5):730-740. DOI: [10.1016/j.jamcollsurg.2018.01.044](https://doi.org/10.1016/j.jamcollsurg.2018.01.044)

[^21]: Moore LJ, Brenner M, Kozar RA, et al. "Implementation of Resuscitative Endovascular Balloon Occlusion of the Aorta as an Alternative to Resuscitative Thoracotomy for Noncompressible Truncal Hemorrhage." *J Trauma Acute Care Surg*. 2015;79(4):523-532. DOI: [10.1097/TA.0000000000000809](https://doi.org/10.1097/TA.0000000000000809)

[^22]: Teasdale G, Maas A, Lecky F, et al. "The Glasgow Coma Scale at 40 Years: Standing the Test of Time." *Lancet Neurol*. 2014;13(8):844-854. DOI: [10.1016/S1474-4422(14)70120-6](https://doi.org/10.1016/S1474-4422(14)70120-6)
